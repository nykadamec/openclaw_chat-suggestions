...
import { An as formatRemainingShort, Bi as resolveUsageProviderId, Cv as DEFAULT_PROVIDER, Dg as resolveOpenClawAgentDir, Dn as maskApiKey, Eg as shouldSuppressBuiltInModel, F as resolveModelRefFromString, F_ as resolveAwsSdkEnvVarName, I_ as resolveEnvApiKey, Ig as readConfigFileSnapshotForWrite, Iv as resolveAuthProfileDisplayLabel, J as getModelsCommandSecretTargetIds, L_ as resolveUsableCustomProviderApiKey, Li as loadProviderUsageSummary, Lr as runEmbeddedPiAgent, M as resolveConfiguredModelRef, M_ as getCustomProviderApiKey, Mg as loadConfig, N as resolveDefaultModelForAgent, N_ as hasUsableCustomProviderApiKey, O as normalizeProviderId, On as DEFAULT_OAUTH_WARN_MS, P_ as resolveApiKeyForProvider, R as resolvePluginProviders, R_ as getShellEnvAppliedKeys, Rg as setRuntimeConfigSnapshot, Sv as DEFAULT_MODEL, T as modelKey, W as withProgressTotals, Xm as resolveSecretRefString, Z as resolveCommandSecretRefsViaGateway, b as buildModelAliasIndex, d as setAuthProfileOrder, f as upsertAuthProfile, ff as discoverAuthStorage, fo as describeFailoverError, fv as isNonSecretApiKeyMarker, jg as createConfigIO, k as parseModelRef, kn as buildAuthHealthSummary, lf as resolveModelWithRegistry, n as resolveAuthProfileOrder, p as ensureAuthProfileStore, pf as discoverModels, r as resolveProfileUnusableUntilForDisplay, t as resolveAuthProfileEligibility, u as listProfilesForProvider, v as resolveAuthStorePathForDisplay, wg as loadModelCatalog, wt as openUrl, x as findNormalizedProviderValue, z_ as shouldEnableShellEnvFallback, zi as formatUsageWindowSummary } from "./auth-profiles-C-CuFECu.js";
...
import { i as parseDurationMs } from "./search-manager-Cs3e6DNF.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles.runtime-BJWMotnO.js");
	const { ensureOpenClawModelsJson } = await import("./auth-profiles-C-CuFECu.js").then((n) => n.Tg);
