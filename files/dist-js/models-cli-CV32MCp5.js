...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles.runtime-CUcIReCW.js");
	const { ensureOpenClawModelsJson } = await import("./reply-C8St2AJ2.js").then((n) => n.mf);
