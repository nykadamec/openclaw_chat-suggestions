...
import { Dt as randomToken, Fg as readConfigFileSnapshot, Mt as waitForGatewayReachable, Ot as resolveControlUiLinks, St as normalizeGatewayTokenInput, _t as ensureWorkspaceAndSessions, bt as handleReset, mt as applyWizardMetadata, pt as DEFAULT_WORKSPACE, zg as writeConfigFile } from "./auth-profiles-C-CuFECu.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-BeD30J1E.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-D58xkd6Z.js");
