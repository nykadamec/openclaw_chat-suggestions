...
import { $c as validateNodeEventParams, $d as resolveTtsAutoMode, $f as readSessionMessages, $g as isAvatarHttpUrl, $l as deriveDeviceIdFromPublicKey, $n as updatePairedNodeMetadata, $r as buildDefaultToolPolicyPipelineSteps, $s as PAIRING_SCOPE$1, $u as waitForActiveTasks, A as resolveAllowedModelRef, Ac as validateConnectParams, Af as resolveAgentSessionDirs, Ag as migrateLegacyConfig, Ah as normalizeRateLimitClientIp, Ai as readLatestAssistantReply, Al as validateTalkConfigParams, Ao as normalizeHttpWebhookUrl, Ar as resolveSendPolicy, Au as saveExecApprovals, Av as normalizeReasoningLevel, B as createPluginRuntime, B_ as getGlobalHookRunner, Bc as validateDevicePairRejectParams, Bd as isSilentReplyText, Bf as updateSessionStore, Bg as validateConfigObjectWithPlugins, Bh as resolveGatewayBindHost, Bl as validateWizardStatusParams, Bo as normalizePayloadToSystemText, Bp as GATEWAY_CLIENT_CAPS, Br as getActiveEmbeddedRunCount, Bs as missingSystemRunApprovalBinding, C as isCliProvider, Cc as validateConfigApplyParams, Cf as estimateBase64DecodedBytes, Ch as readGatewayPasswordEnv, Ci as emitAgentEvent, Cl as validateSessionsResetParams, Cn as setCliSessionId, Co as consumeRestartSentinel, Cr as DEFAULT_INPUT_TIMEOUT_MS, Cv as DEFAULT_PROVIDER, D as normalizeModelSelection, D_ as buildTalkConfigResponse, Dc as validateConfigSchemaLookupResult, Dh as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, Dl as validateSkillsInstallParams, Do as summarizeRestartSentinel, Dr as resolveInputFileLimits, Ec as validateConfigSchemaLookupParams, Eh as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, Ei as registerAgentRunContext, El as validateSkillsBinsParams, Em as cleanOldMedia, En as resolveSessionAuthProfileOverride, Er as normalizeMimeList, Fc as validateCronRunsParams, Ff as archiveRemovedSessionTranscripts, Fg as readConfigFileSnapshot, Fh as isTrustedProxyAddress, Fi as resolvePreferredSessionKeyForSessionIdMatches, Fl as validateWebLoginStartParams, Fo as resolveDefaultCronStaggerMs, Fp as isGatewayMessageChannel, Fs as resolveSystemRunApprovalRuntimeContext, Ft as normalizeControlUiBasePath, Fv as supportsXHighThinking, G as formatHelpExamples, Gc as validateExecApprovalResolveParams, Gd as resolveAgentIdentity, Gf as deliveryContextFromSession, Gh as pickPrimaryTailnetIPv6, Gi as loadCombinedSessionStoreForGateway, Gl as resolveAuthConnectErrorDetailCode, Gm as mergeGatewayTailscaleConfig, Gn as refreshRemoteNodeBins, Gp as normalizeGatewayClientMode, Gr as resolveBootstrapWarningSignaturesSeen, Gu as clearBootstrapSnapshotOnSessionRollover, Ha as buildOutboundSessionContext, Hc as validateDeviceTokenRevokeParams, Hh as resolveRequestClientIp, Hl as errorShape, Hn as primeRemoteSkillsCache, Hp as GATEWAY_CLIENT_MODES, Hr as waitForEmbeddedPiRunEnd, Hs as toSystemRunApprovalMismatchError, I as resolveSubagentConfiguredModelSelection, Ic as validateCronStatusParams, If as loadSessionStore, Ig as readConfigFileSnapshotForWrite, Ih as isValidIPv4, Ii as applyModelOverrideToSessionEntry, Il as validateWebLoginWaitParams, It as resolveAssistantAvatarUrl, Ja as normalizeReplyPayloadsForDelivery, Jc as validateExecApprovalsNodeSetParams, Jh as disableTailscaleServe, Ji as resolveGatewaySessionStoreTarget, Jl as buildDeviceAuthPayloadV3, Jn as approveNodePairing, Jp as cleanStaleLockFiles, Kc as validateExecApprovalsGetParams, Kf as mergeDeliveryContext, Kg as parseByteSize, Kh as safeEqualSecret, Ki as loadSessionEntry, Kl as resolveDeviceAuthConnectErrorDetailCode, Km as resolveConfiguredSecretInputString, Kn as removeRemoteNodeInfo, Kr as resolveFastModeState, Ks as callGateway, Ku as enqueueCommandInLane, L as resolveThinkingDefault, Lc as validateCronUpdateParams, Lg as resolveConfigSnapshotHash, Lh as normalizeHostHeader, Li as loadProviderUsageSummary, Ll as validateWizardCancelParams, Ln as getChannelActivity, Lo as normalizeOptionalAgentId, Lp as isWebchatClient, Lr as runEmbeddedPiAgent, Ls as resolveSystemRunCommandRequest, M as resolveConfiguredModelRef, Mc as validateCronListParams, Mf as extractDeliveryInfo, Mg as loadConfig, Mh as isLoopbackAddress, Ml as validateToolsCatalogParams, Mn as parseVerboseOverride, Mo as normalizeCronJobPatch, Mp as INTERNAL_MESSAGE_CHANNEL, Mu as getPluginToolMeta, Mv as normalizeUsageDisplay, N as resolveDefaultModelForAgent, Na as resolveOutboundTarget, Nc as validateCronRemoveParams, Nd as resolveUserTimezone, Nf as parseSessionThreadInfo, Ng as parseConfigJson5, Nh as isLoopbackHost, Nl as validateUpdateRunParams, Nn as unbindThreadBindingsBySessionKey, No as normalizeCronStaggerMs, Np as isDeliverableMessageChannel, Nr as isAbortRequestText, Nt as CONTROL_UI_AVATAR_PREFIX, Nu as resolvePluginTools, Nv as normalizeVerboseLevel, O_ as resolveAgentMaxConcurrent, Oc as validateConfigSchemaParams, Od as ToolInputError, Oh as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, Ol as validateSkillsStatusParams, Ov as normalizeElevatedLevel, P as resolveHooksGmailModel, Pa as resolveSessionDeliveryTarget, Pc as validateCronRunParams, Pg as readBestEffortConfig, Pi as resolveNestedAgentLane, Pl as validateWakeParams, Po as resolveCronStaggerMs, Pp as isGatewayCliClient, Pr as stopSubagentsForRequester, Ps as resolveSystemRunApprovalRequestContext, Pt as buildControlUiAvatarUrl, Qc as validateNodeDescribeParams, Qd as resolveTtsApiKey, Qf as cleanupArchivedSessionTranscripts, Qg as AVATAR_MAX_BYTES, Qh as getTailnetHostname, Qi as lookupContextTokens, Ql as loadGatewayTlsRuntime$1, Qn as requestNodePairing, Qp as writeJsonAtomic, Qr as applyToolPolicyPipeline, Qs as APPROVALS_SCOPE$1, Qu as setCommandLaneConcurrency, Rc as validateDevicePairApproveParams, Rd as SILENT_REPLY_TOKEN, Rh as pickPrimaryLanIPv4, Rl as validateWizardNextParams, Ro as normalizeOptionalSessionKey, Rp as normalizeMessageChannel, Rs as buildSystemRunApprovalBinding, Rt as resolveExecApprovalCommandDisplay, S as getModelRefStatus, Sc as validateChatSuggestionsParams, Si as clearAgentRunContext, Sl as validateSessionsPreviewParams, Sn as getCliSessionId, So as triggerOpenClawRestart, Sr as DEFAULT_INPUT_IMAGE_MIMES, Su as normalizeExecApprovals, Sv as DEFAULT_MODEL, Tc as validateConfigPatchParams, Ti as onAgentEvent, Tl as validateSessionsUsageParams, Tm as rawDataToString, To as formatRestartSentinelMessage, Tr as extractImageContentFromSource, Tu as readExecApprovalsSnapshot, Tv as formatXHighModelHint, U as withProgress, Ua as deliverOutboundPayloads, Uc as validateDeviceTokenRotateParams, Ui as listAgentsForGateway, Ul as parseSessionLabel, Um as ensureGatewayStartupAuth, Un as recordRemoteNodeInfo, Uo as parseAbsoluteTimeMs, Up as GATEWAY_CLIENT_NAMES, V_ as runGlobalGatewayStopSafely, Vc as validateDevicePairRemoveParams, Vg as OpenClawSchema, Vh as resolveGatewayListenHosts, Vi as canonicalizeSpawnedByForAgent, Vl as ErrorCodes, Vn as getRemoteSkillEligibility, Vo as normalizeRequiredName, Vp as GATEWAY_CLIENT_IDS, Vr as waitForActiveEmbeddedRuns, Wc as validateExecApprovalRequestParams, Wh as pickPrimaryTailnetIPv4, Wi as listSessionsFromStore, Wl as ConnectErrorDetailCodes, Wm as mergeGatewayAuthConfig, Wn as refreshRemoteBinsForConnectedNodes, Wo as normalizeLegacyDeliveryInput, Wp as hasGatewayClientCap, Ws as buildExecApprovalPendingReplyPayload, Wt as resolveAgentAvatar, Wu as clearBootstrapSnapshot, Xa as resolveOutboundChannelPlugin, Xc as validateLogsTailParams, Xd as isTtsEnabled, Xf as archiveSessionTranscripts, Xh as enableTailscaleServe, Xn as rejectNodePairing, Xp as createAsyncLock, Xt as createReplyPrefixOptions, Xu as markGatewayDraining, Yc as validateExecApprovalsSetParams, Yd as getTtsProvider, Yf as archiveFileOnDisk, Yh as enableTailscaleFunnel, Yi as resolveSessionModelRef, Yl as normalizeDeviceMetadataForAuth, Yn as listNodePairing, Yp as isPidAlive, Yr as resolveCronStyleNow, Yu as getTotalQueueSize, Za as applyPluginAutoEnable, Zc as validateModelsListParams, Zd as isTtsProviderConfigured, Zf as capArrayByJsonBytes, Zl as normalizeDeviceAuthScopes, Zn as renamePairedNode, Zp as readJsonFile, Zr as resolveToolLoopDetectionConfig, Zs as ADMIN_SCOPE$3, Zt as buildHistoryContextFromEntries, Zu as resetAllLanes, __ as ensureControlUiAllowedOriginsForNonLoopbackBind, _c as validateChannelsStatusParams, _g as extractTextFromChatContent, _h as authorizeWsControlUiGatewayConnect, _l as validateSendParams, _o as isGatewaySigusr1RestartExternallyAllowed, _p as resolveAgentMainSessionKey, _r as getSkillsSnapshotVersion, _s as isKnownSecretTargetId, _u as ensureExecApprovals, aa as normalizeGroupActivation, ac as formatValidationErrors, ad as isDiagnosticsEnabled, af as textToSpeech, ag as mergeAlsoAllowPolicy, al as validateNodePairRejectParams, ao as resolveMessageChannelSelection, ap as stripInlineDirectiveTagsFromMessageForDisplay, as as closeTrackedBrowserTabsForSessions, at as resolveAgentOutboundIdentity, au as enqueueSystemEvent, bc as validateChatInjectParams, bi as normalizeSpawnedRunMetadata, bl as validateSessionsListParams, bn as resolveCronStorePath, bo as setGatewaySigusr1RestartPolicy, bp as resolveMainSessionKeyFromConfig, bt as handleReset, bu as mergeExecApprovalsSocketDefaults, bv as normalizeSecretInput, cc as validateAgentWaitParams, ci as countActiveDescendantRuns, cl as validateNodePendingAckParams, co as runWithModelFallback, cs as activateSecretsRuntimeSnapshot, dc as validateAgentsFilesGetParams, dd as getMachineDisplayName, di as initSubagentRegistry, dl as validateNodeRenameParams, dp as resolveSessionResetPolicy, ds as prepareSecretsRuntimeSnapshot, du as requestHeartbeatNow, e_ as isAvatarImageDataUrl, ea as computeBackoff, ed as CommandLane, ef as resolveTtsConfig, el as validateNodeInvokeParams, eo as buildChannelUiCatalog, ep as readSessionPreviewItemsFromTranscript, er as verifyNodeToken, eu as loadOrCreateDeviceIdentity, fa as parseTimeoutMsWithFallback, fc as validateAgentsFilesListParams, fl as validatePollParams, fs as resolveCommandSecretsFromActiveRuntimeSnapshot, g_ as applyLegacyMigrations, gc as validateChannelsLogoutParams, gh as authorizeHttpGatewayConnect, gl as validateSecretsResolveResult, gn as getTotalPendingReplies, go as emitGatewayRestart, gp as canonicalizeMainSessionAlias, h_ as applyMergePatch, ha as resolveOutboundSessionRoute, hc as validateAgentsUpdateParams, hd as getAcpSessionManager, hh as assertGatewayAuthConfigured, hl as validateSecretsResolveParams, hm as startBrowserControlServiceFromConfig, hn as createReplyDispatcher, ho as deferGatewayRestartUntilIdle, hp as setSessionRuntimeModel, hu as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS, if as setTtsProvider, ig as collectExplicitAllowlist, ii as resolveSubagentToolPolicy, il as validateNodePairListParams, io as resetDirectoryCache, ip as stripInlineDirectiveTagsForDisplay, is as isExternalHookSession, iu as verifyDeviceSignature, jc as validateCronAddParams, jg as createConfigIO, jh as isLocalishHost, ji as resolveAnnounceTargetFromKey, jl as validateTalkModeParams, jn as applyVerboseOverride, jo as normalizeCronJobCreate, jv as normalizeThinkLevel, k_ as resolveSubagentMaxConcurrent, kc as validateConfigSetParams, kh as createAuthRateLimiter, kl as validateSkillsUpdateParams, ko as writeRestartSentinel, kr as normalizeSendPolicy, kv as normalizeFastMode, lc as validateAgentsCreateParams, lg as listCoreToolSections, ll as validateNodePendingDrainParams, lp as evaluateSessionFreshness, ls as clearSecretsRuntimeSnapshot, ma as ensureOutboundSessionEntry, mc as validateAgentsListParams, md as stripHeartbeatToken, ml as validateRequestFrame, mm as createBrowserControlContext, mn as dispatchInboundMessage, mo as consumeGatewaySigusr1RestartAuthorization, ms as evaluateGatewayAuthSurfaceStates, nc as authorizeOperatorScopesForMethod, nd as startDiagnosticHeartbeat, nf as resolveTtsProviderOrder, ni as resolveEffectiveToolPolicy, nl as validateNodeListParams, np as stripEnvelopeFromMessage, ns as detectSuspiciousPatterns, nt as buildTelegramExecApprovalButtons, nu as publicKeyRawBase64UrlFromPem, oc as validateAgentIdentityParams, of as OPENAI_TTS_MODELS, og as resolveToolProfilePolicy, oi as runBeforeToolCallHook, ol as validateNodePairRequestParams, oo as normalizePollInput, op as normalizeInputProvenance, or as listAgentWorkspaceDirs, os as applyBrowserProxyPaths, ou as isSystemEventContextChanged, pc as validateAgentsFilesSetParams, pi as listDescendantRunsForRequester, pl as validatePushTestParams, pm as createBrowserRouteDispatcher, po as resolveFailoverReasonFromError, pp as mergeSessionEntry, ps as GATEWAY_AUTH_SURFACE_PATHS, pu as setHeartbeatsEnabled, qc as validateExecApprovalsNodeGetParams, qf as normalizeSessionDeliveryFields, qh as disableTailscaleFunnel, qi as migrateAndPruneGatewaySessionStoreKey, ql as buildDeviceAuthPayload, qn as setSkillsRemoteRegistry, qu as getActiveTaskCount, ra as clearSessionQueues, rc as isNodeRoleMethod, rd as stopDiagnosticHeartbeat, rf as setTtsEnabled, ri as resolveGroupToolPolicy, rl as validateNodePairApproveParams, ro as maybeResolveIdLikeTarget, rp as stripEnvelopeFromMessages, rs as getHookType, rt as resolveExecApprovalSessionTarget, sc as validateAgentParams, sf as OPENAI_TTS_VOICES, sg as PROFILE_OPTIONS, si as createOpenClawTools, sl as validateNodePairVerifyParams, sn as sendTypingTelegram, sp as jsonUtf8Bytes, sr as formatZonedTimestamp, ss as persistBrowserProxyFiles, st as handleSlackHttpRequest, t_ as looksLikeAvatarPath, ta as sleepWithAbort, tc as WRITE_SCOPE, tf as resolveTtsPrefsPath, tl as validateNodeInvokeResultParams, tp as resolveSessionTranscriptCandidates, ts as buildSafeExternalPrompt, tu as normalizeDevicePublicKeyBase64Url, uc as validateAgentsDeleteParams, ud as resolveMemorySearchConfig, ug as resolveCoreToolProfiles, ul as validateNodePendingEnqueueParams, us as getActiveSecretsRuntimeSnapshot, vc as validateChatAbortParams, vg as fetchWithSsrFGuard, vh as isLocalDirectRequest, vi as resolveAgentTimeoutMs, vl as validateSessionsCompactParams, vn as buildBareSessionResetPrompt, vo as markGatewaySigusr1RestartHandled, vp as resolveExplicitAgentSessionKey, vr as registerSkillsChangeListener, wc as validateConfigGetParams, wd as isRestartEnabled, wg as loadModelCatalog, wh as readGatewayTokenEnv, wi as getAgentRunContext, wl as validateSessionsResolveParams, wn as runCliAgent, wo as formatDoctorNonInteractiveHint, wr as extractFileContentFromSource, wv as formatThinkingLevels, xc as validateChatSendParams, xg as registerUnhandledRejectionHandler, xi as resolveIngressWorkspaceOverrideForSpawnedRun, xl as validateSessionsPatchParams, xn as saveCronStore, xo as setPreRestartDeferralCheck, xp as snapshotSessionOrigin, xr as DEFAULT_INPUT_IMAGE_MAX_BYTES, y as buildAllowedModelSet, ya as readChannelAllowFromStoreSync, yc as validateChatHistoryParams, yg as SsrFBlockedError, yh as resolveGatewayAuth, yl as validateSessionsDeleteParams, ym as movePathToTrash, yn as loadCronStore, yo as scheduleGatewaySigusr1Restart, yp as resolveMainSessionKey, z as loadOpenClawPlugins, zc as validateDevicePairListParams, zg as writeConfigFile, zh as resolveClientIp, zl as validateWizardStartParams, zo as normalizeOptionalText$1, zr as abortEmbeddedPiRun, zs as matchSystemRunApprovalBinding, zt as sanitizeExecApprovalDisplayText } from "./auth-profiles-C-CuFECu.js";
...
import { i as parseDurationMs, r as resolveMemoryBackendConfig, t as getMemorySearchManager } from "./search-manager-Cs3e6DNF.js";
...
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-_oyac3JB.js";
import { t as isWithinDir } from "./path-safety-Z97FO1K-.js";
import "./install-safe-path-DZM2JHcC.js";
import "./skill-scanner-Ms0uZYdw.js";
import { n as formatConfigIssueLines } from "./issue-format-CrqoR4yn.js";
import { t as buildChannelAccountSnapshot } from "./status-CW5FEPJ3.js";
import "./channels-status-issues-D0D1GN5e.js";
import { n as verifyDeviceBootstrapToken } from "./device-bootstrap-DleUWR3y.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-DbrEqhN6.js";
...
import { t as discoverGatewayBeacons } from "./bonjour-discovery-CbHge-Qy.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-B-euTZrV.js";
import { a as styleHealthChannelLine, c as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-7BMY2kAr.js";
import { n as createDefaultDeps, r as createOutboundSendDeps$1, t as createOutboundSendDeps } from "./outbound-send-deps-CidttvqG.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-DbBQ68d3.js");
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-CwRzDSUN.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		...
		const { deliverOutboundPayloads } = await import("./auth-profiles-C-CuFECu.js").then((n) => n.Wa);
