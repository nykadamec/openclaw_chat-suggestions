...
import { $ as resolveCommandSecretRefsViaGateway, A as normalizeProviderId, B as resolvePluginProviders, C as findNormalizedProviderValue, D as modelKey, Dt as openUrl, Dv as resolveOpenClawAgentDir, Ev as resolveAuthStorePathForDisplay, F as resolveDefaultModelForAgent, Fv as DEFAULT_MODEL, Iv as DEFAULT_PROVIDER, Jf as isNonSecretApiKeyMarker, K as withProgressTotals, Kd as resolveModelWithRegistry, L as resolveModelRefFromString, P as resolveConfiguredModelRef, S as buildModelAliasIndex, Si as resolveUsageProviderId, T_ as parseDurationMs, Wg as resolveSecretRefString, X as getModelsCommandSecretTargetIds, Xd as discoverModels, Yd as discoverAuthStorage, __ as setRuntimeConfigSnapshot, _f as hasUsableCustomProviderApiKey, bf as resolveEnvApiKey, bv as upsertAuthProfile, c as buildAuthHealthSummary, d_ as loadConfig, gf as getCustomProviderApiKey, h_ as readConfigFileSnapshotForWrite, hf as shouldSuppressBuiltInModel, hv as shouldEnableShellEnvFallback, j as parseModelRef, kv as resolveAuthProfileDisplayLabel, l as formatRemainingShort, mv as getShellEnvAppliedKeys, np as resolveAuthProfileOrder, o as maskApiKey, pf as loadModelCatalog, qa as describeFailoverError, rp as resolveProfileUnusableUntilForDisplay, s as DEFAULT_OAUTH_WARN_MS, tp as resolveAuthProfileEligibility, u_ as createConfigIO, vf as resolveApiKeyForProvider, vv as listProfilesForProvider, xf as resolveUsableCustomProviderApiKey, xi as formatUsageWindowSummary, xv as ensureAuthProfileStore, yf as resolveAwsSdkEnvVarName, yi as loadProviderUsageSummary, yr as runEmbeddedPiAgent, yv as setAuthProfileOrder } from "./reply-CeB3PWQv.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles.runtime-C3HM_Fe3.js");
	const { ensureOpenClawModelsJson } = await import("./reply-CeB3PWQv.js").then((n) => n.mf);
