...
import { i as parseDurationMs, r as resolveMemoryBackendConfig, t as getMemorySearchManager } from "./search-manager-D6ysFFBZ.js";
...
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-bO0nejB6.js";
import { t as isWithinDir } from "./path-safety-Z97FO1K-.js";
import "./install-safe-path-DZM2JHcC.js";
import "./skill-scanner-Ms0uZYdw.js";
import { n as formatConfigIssueLines } from "./issue-format-Bwf24-5Z.js";
import { t as buildChannelAccountSnapshot } from "./status-INOZHnyK.js";
import "./channels-status-issues-D0D1GN5e.js";
import { n as verifyDeviceBootstrapToken } from "./device-bootstrap-CR50z9m9.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-CxhFzPNe.js";
...
import { t as discoverGatewayBeacons } from "./bonjour-discovery-DtZL_idf.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-Cnr_U8tV.js";
import { a as styleHealthChannelLine, c as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-CswslSE1.js";
import { n as createDefaultDeps, r as createOutboundSendDeps$1, t as createOutboundSendDeps } from "./outbound-send-deps-BwyIlG1N.js";
...
import { f as normalizeStoredCronJobs, h as computePreviousRunAtMs, m as computeNextRunAtMs, p as coerceFiniteScheduleNumber, t as runGatewayUpdate } from "./update-runner-0Ek22jCn.js";
import { a as resolveAgentOutboundTarget, i as resolveAgentDeliveryPlan, n as agentCommandFromIngress } from "./agent--2PqrlGD.js";
import { n as isNodeCommandAllowed, r as resolveNodeCommandAllowlist } from "./node-command-policy-B9LsJEtr.js";
...
import { t as installSkill } from "./skills-install-CZII9eOd.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-BFy5cvk6.js");
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-Bx64s_SF.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		...
		const { deliverOutboundPayloads } = await import("./auth-profiles-CWGpGLAg.js").then((n) => n.Wa);
