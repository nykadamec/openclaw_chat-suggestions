...
import { m_ as readConfigFileSnapshot, v_ as writeConfigFile } from "./reply-C8St2AJ2.js";
...
async function runOnboardingWizard(opts, runtime = defaultRuntime, prompter) {
	const onboardHelpers = await import("./reply-C8St2AJ2.js").then((n) => n.Et);
	...
	if (mode === "remote") {
		const { promptRemoteGatewayConfig } = await import("./onboard-remote-DLbbumLW.js").then((n) => n.t);
		const { logConfigUpdated } = await import("./logging-W9uB8zlG.js").then((n) => n.r);
	...
	const { promptAuthChoiceGrouped } = await import("./auth-choice-prompt-BsMcj09s.js").then((n) => n.t);
	const { promptCustomApiConfig } = await import("./onboard-custom-BgIZJoqT.js").then((n) => n.r);
	const { applyAuthChoice, resolvePreferredProviderForAuthChoice, warnIfModelConfigLooksOff } = await import("./auth-choice-CBcVET5P.js").then((n) => n.t);
	const { applyPrimaryModel, promptDefaultModel } = await import("./model-picker-CrPifw65.js").then((n) => n.i);
	...
	const { configureGatewayForOnboarding } = await import("./onboarding.gateway-config-Cgih3v4u.js");
	...
	if (opts.skipChannels ?? opts.skipProviders) await prompter.note("Skipping channel setup.", "Channels");
		...
		const { setupChannels } = await import("./onboard-channels-CRrK1n1l.js").then((n) => n.n);
	...
	if (opts.skipSkills) await prompter.note("Skipping skills setup.", "Skills");
		...
		const { setupSkills } = await import("./onboard-skills-CMPfXRYj.js").then((n) => n.t);
	...
	await writeConfigFile(nextConfig);
	const { finalizeOnboardingWizard } = await import("./onboarding.finalize-DHFKpvQk.js");
