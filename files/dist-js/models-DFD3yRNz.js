...
import { i as parseDurationMs } from "./search-manager-D6ysFFBZ.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles.runtime-DX1mjviP.js");
	const { ensureOpenClawModelsJson } = await import("./auth-profiles-CWGpGLAg.js").then((n) => n.Tg);
