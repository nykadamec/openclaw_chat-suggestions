...
import { Fg as readConfigFileSnapshot, zg as writeConfigFile } from "./auth-profiles-C-CuFECu.js";
...
async function runOnboardingWizard(opts, runtime = defaultRuntime, prompter) {
	const onboardHelpers = await import("./auth-profiles-C-CuFECu.js").then((n) => n.Ct);
	...
	if (mode === "remote") {
		const { promptRemoteGatewayConfig } = await import("./onboard-remote-BAChjKui.js").then((n) => n.t);
		const { logConfigUpdated } = await import("./logging-Ff99r45z.js").then((n) => n.r);
	...
	const { promptAuthChoiceGrouped } = await import("./auth-choice-prompt-DO6K0Qd5.js").then((n) => n.t);
	const { promptCustomApiConfig } = await import("./onboard-custom-B2Ap7csK.js").then((n) => n.r);
	const { applyAuthChoice, resolvePreferredProviderForAuthChoice, warnIfModelConfigLooksOff } = await import("./auth-choice-BV5XVkHb.js").then((n) => n.t);
	const { applyPrimaryModel, promptDefaultModel } = await import("./model-picker-Di8KJG6b.js").then((n) => n.i);
	...
	const { configureGatewayForOnboarding } = await import("./onboarding.gateway-config-BH-YcT_J.js");
	...
	if (opts.skipChannels ?? opts.skipProviders) await prompter.note("Skipping channel setup.", "Channels");
		...
		const { setupChannels } = await import("./onboard-channels-E1V_nNND.js").then((n) => n.n);
	...
	if (opts.skipSkills) await prompter.note("Skipping skills setup.", "Skills");
		...
		const { setupSkills } = await import("./onboard-skills-C66CJ0NT.js").then((n) => n.t);
	...
	await writeConfigFile(nextConfig);
	const { finalizeOnboardingWizard } = await import("./onboarding.finalize-Bqr8MoDH.js");
