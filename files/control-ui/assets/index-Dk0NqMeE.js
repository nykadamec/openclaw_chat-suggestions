const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./agents-DhhcMCCy.js","./lit-BZwq2xLD.js","./format-DeRVtGzv.js","./channel-config-extras-UBRJa-vU.js","./skills-shared-CPLqvR1x.js","./channels-BXy_MYLs.js","./cron-C3uQ13-x.js","./debug-xYOndlEx.js","./instances-DdRIsNb1.js","./logs-BbHV8FOx.js","./nodes-BwDIV1x7.js","./sessions-B9eOwvgG.js","./skills-BaxA3XRt.js"])))=>i.map(i=>d[i]);
...
`)}var Wd=`openclaw:skipDeleteConfirm`;function Gd(){try{return localStorage.getItem(Wd)===`1`}catch{return!1}}function Kd(e,t){return n`
  ...
  `}render(){return i}connectedCallback(){super.connectedCallback(),this.addEventListener(`mousedown`,this.handleMouseDown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`mousedown`,this.handleMouseDown),document.removeEventListener(`mousemove`,this.handleMouseMove),document.removeEventListener(`mouseup`,this.handleMouseUp)}};J([x({type:Number})],gf.prototype,`splitRatio`,void 0),J([x({type:Number})],gf.prototype,`minRatio`,void 0),J([x({type:Number})],gf.prototype,`maxRatio`,void 0),gf=J([v(`resizable-divider`)],gf);var _f=5e3,vf=8e3,yf=new Map,bf=new Map,xf=new Map;function Sf(e){return lf(yf,e,()=>new rf)}function Cf(e){return lf(bf,e,()=>new of(e))}function wf(e){return lf(xf,e,()=>new Ka(e))}function Tf(){return{sttRecording:!1,sttInterimText:``,slashMenuOpen:!1,slashMenuItems:[],slashMenuIndex:0,slashMenuMode:`command`,slashMenuCommand:null,slashMenuArgItems:[],searchOpen:!1,searchQuery:``,pinnedExpanded:!1,suggestionsLoadingSessionKey:null,suggestionsLoadingLabels:[]}}var Y=Tf();function Ef(){Y.sttRecording&&Eu(),Object.assign(Y,Tf())}function Df(e){e.style.height=`auto`,e.style.height=`${Math.min(e.scrollHeight,150)}px`}function Of(e){return e?e.active?n`
  ...
  `}function Yf(e){return`Please implement ${e.toLowerCase()} in the current product flow.`}function Xf(e){let t=e.suggestions??[],n=t.length>0,r=t.some(e=>e.source===`fallback`);return e.suggestionsLoading&&!n?{label:`Loading`,tone:`loading`}:e.suggestionsLoading&&n?{label:`Refreshing`,tone:`refreshing`}:e.suggestionsError||r?{label:`Fallback`,tone:`fallback`}:{label:`Ready`,tone:`ready`}}function Zf(e){if(!e.connected)return i;let t=!!(e.suggestions&&e.suggestions.length>0),r=!!(e.suggestionsLoading&&t),a=!!(e.suggestionsSettling&&t),o=Xf(e),s=t?[{title:`Suggestions`,items:e.suggestions.map(e=>({label:e.label,prompt:e.prompt}))}]:Wf.map(e=>({title:e.title,items:e.items.map(e=>({label:e,prompt:Yf(e)}))}));return n`
    <div class="agent-chat__composer-suggestions">
      <div class="agent-chat__composer-suggestions-header">
        <span class="agent-chat__composer-suggestions-title"
          >Suggestions<small style="padding-left: 6px; opacity: 0.3;">0.1.1</small></span
        >
        ${e.onRefreshSuggestions?n`
                <div class="agent-chat__composer-actions">
                  <span
                    class=${`agent-chat__composer-status agent-chat__composer-status--${o.tone}`}
                  >
                    ${o.label}
                  </span>
                  <span
                    class=${`agent-chat__composer-status ${e.suggestionsAutoRefresh===!1?`agent-chat__composer-status--manual`:`agent-chat__composer-status--auto`}`}
                    title="Right click refresh to toggle Auto/Manual"
                    >${e.suggestionsAutoRefresh===!1?`Manual`:`Auto`}</span
                  >
                  <button
                    type="button"
                    class=${`agent-chat__composer-refresh ${e.suggestionsAutoRefresh===!1?`agent-chat__composer-refresh--manual`:`agent-chat__composer-refresh--auto`}`}
                    title=${e.suggestionsAutoRefresh===!1?`Refresh suggestions (manual mode)`:`Refresh suggestions (auto mode)`}
                    ?disabled=${!!e.suggestionsLoading}
                    @click=${()=>void e.onRefreshSuggestions?.()}
                    @contextmenu=${t=>{t.preventDefault(),e.onToggleSuggestionsAutoRefresh?.()}}
                  >
                    ${e.suggestionsLoading?W.loader:W.refresh}
                  </button>
                </div>
              `:i}
      </div>

      ${e.suggestionsContextHint?n`
              <div class="agent-chat__composer-selection-hint">${e.suggestionsContextHint}</div>
            `:i}

      ${e.suggestionsLoading&&(!e.suggestions||e.suggestions.length===0)?n`
              <div class="agent-chat__composer-group">
                <div
                  class="agent-chat__composer-chips agent-chat__composer-chips--loading"
                  aria-label="Loading suggestions"
                >
                  ${qf(e.sessionKey).map(e=>n`
                      <button type="button" class="agent-chat__composer-chip" disabled>
                        ${e}
                      </button>
                    `)}
                </div>
            ...
            `:n`
              ${s.map(t=>n`
                  <div class="agent-chat__composer-group">
                    <div
                      class=${`agent-chat__composer-chips${r?` agent-chat__composer-chips--loading`:``}${a?` agent-chat__composer-chips--settling`:``}`}
                      aria-label=${t.title}
                    >
                      ${t.items.map(t=>n`
                  <button
                    type="button"
                    class="agent-chat__composer-chip"
                    ?disabled=${r}
                    @click=${()=>{e.onDraftChange(t.prompt)}}
                  >
                    ${t.label}
                  </button>
                `)}
  ...
  `:i}function $f(e,t,r){let a=Array.isArray(e.messages)?e.messages:[],o=[];for(let e of t.indices){let t=a[e];if(!t)continue;let n=sf(t),r=typeof t.role==`string`?t.role:`unknown`;o.push({index:e,text:n,role:r})}return o.length===0?i:n`
  ...
  `}function tp(e){let t=e.connected,r=e.sending||e.stream!==null,a=!!(e.canAbort&&e.onAbort),o=e.sessions?.sessions?.find(t=>t.key===e.sessionKey),s=o?.reasoningLevel??`off`,c=e.showThinking&&s!==`off`,l={name:e.assistantName,avatar:Bl({identity:{avatar:e.assistantAvatar??void 0,avatarUrl:e.assistantAvatarUrl??void 0}})??null},u=Cf(e.sessionKey),d=wf(e.sessionKey),f=Sf(e.sessionKey),p=(e.attachments?.length??0)>0,m=Hf(e.draft),h=e.connected?p?`Add a message or paste more images...`:`Message ${e.assistantName||`agent`} (Enter to send)`:`Connect to the gateway to start chatting...`,g=e.onRequestUpdate??(()=>{}),_=e.getDraft??(()=>e.draft),v=e.splitRatio??.6,y=!!(e.sidebarOpen&&e.onCloseSidebar),b=e=>{let t=e.target.closest(`.code-block-copy`);if(!t)return;let n=t.dataset.code??``;navigator.clipboard.writeText(n).then(()=>{t.classList.add(`copied`),setTimeout(()=>t.classList.remove(`copied`),1500)},()=>{})},x=t=>{if(!e.onSelectionContextChange||!t)return;let n=window.getSelection();if(!n||n.rangeCount===0){e.onSelectionContextChange(null);return}let r=n.toString().trim();if(!r){e.onSelectionContextChange(null);return}let i=n.getRangeAt(0).commonAncestorContainer,a=i instanceof Element?i:i.parentElement;if(!a||!t.contains(a)){e.onSelectionContextChange(null);return}e.onSelectionContextChange(r.slice(0,1200))},S=e=>{let t=e.currentTarget;x(t)},ee=ip(e),C=ee.length===0&&!e.loading,w=n`
    ...
    >
      ...
      ${e.loading?n`
            ...
            `:i}
      ${C&&!Y.searchOpen?Jf(e):i}
      ${C&&Y.searchOpen?n`
              <div class="agent-chat__empty">No matching messages</div>
            `:i}
      ${Ha(ee,e=>e.key,t=>t.kind===`divider`?n`
...
`)}}async function wm(e,t){try{return await e.request(`sessions.compact`,{key:t}),{content:`Context compacted successfully.`,action:`refresh`}}catch(e){return{content:`Compaction failed: ${String(e)}`}}}async function Tm(e,t,n){if(!n)try{let[n,r]=await Promise.all([e.request(`sessions.list`,{}),e.request(`models.list`,{})]),i=zm(n,t)?.model||n?.defaults?.model||`default`,a=r?.models?.map(e=>e.id)??[],o=[`**Current model:** \`${i}\``];return a.length>0&&o.push(`**Available:** ${a.slice(0,10).map(e=>`\`${e}\``).join(`, `)}${a.length>10?` +${a.length-10} more`:``}`),{content:o.join(`
`)}}catch(e){return{content:`Failed to get model info: ${String(e)}`}}try{return await e.request(`sessions.patch`,{key:t,model:n.trim()}),{content:`Model set to \`${n.trim()}\`.`,action:`refresh`,sessionPatch:{model:n.trim()}}}catch(e){return{content:`Failed to set model: ${String(e)}`}}}async function Em(e,t,n){let r=n.trim();if(!r)try{let{session:n,models:r}=await Bm(e,t);return{content:Lm(`Current thinking level: ${Vm(n,r)}.`,lm(n?.modelProvider,n?.model))}}catch(e){return{content:`Failed to get thinking level: ${String(e)}`}}let i=am(r);if(!i)try{let n=await Rm(e,t);return{content:`Unrecognized thinking level "${r}". Valid levels: ${lm(n?.modelProvider,n?.model)}.`}}catch(e){return{content:`Failed to validate thinking level: ${String(e)}`}}try{return await e.request(`sessions.patch`,{key:t,thinkingLevel:i}),{content:`Thinking level set to **${i}**.`,action:`refresh`}}catch(e){return{content:`Failed to set thinking level: ${String(e)}`}}}async function Dm(e,t,n){let r=n.trim();if(!r)try{return{content:Lm(`Current verbose level: ${fm((await Rm(e,t))?.verboseLevel)??`off`}.`,`on, full, off`)}}catch(e){return{content:`Failed to get verbose level: ${String(e)}`}}let i=fm(r);if(!i)return{content:`Unrecognized verbose level "${r}". Valid levels: off, on, full.`};try{return await e.request(`sessions.patch`,{key:t,verboseLevel:i}),{content:`Verbose mode set to **${i}**.`,action:`refresh`}}catch(e){return{content:`Failed to set verbose mode: ${String(e)}`}}}async function Om(e,t,n){let r=n.trim().toLowerCase();if(!r||r===`status`)try{return{content:Lm(`Current fast mode: ${Hm(await Rm(e,t))}.`,`status, on, off`)}}catch(e){return{content:`Failed to get fast mode: ${String(e)}`}}if(r!==`on`&&r!==`off`)return{content:`Unrecognized fast mode "${n.trim()}". Valid levels: status, on, off.`};try{return await e.request(`sessions.patch`,{key:t,fastMode:r===`on`}),{content:`Fast mode ${r===`on`?`enabled`:`disabled`}.`,action:`refresh`}}catch(e){return{content:`Failed to set fast mode: ${String(e)}`}}}async function km(e,t){try{let n=zm(await e.request(`sessions.list`,{}),t);if(!n)return{content:`No active session.`};let r=n.inputTokens??0,i=n.outputTokens??0,a=n.totalTokens??r+i,o=n.contextTokens??0,s=o>0?Math.round(r/o*100):null,c=[`**Session Usage**`,`Input: **${Um(r)}** tokens`,`Output: **${Um(i)}** tokens`,`Total: **${Um(a)}** tokens`];return s!==null&&c.push(`Context: **${s}%** of ${Um(o)}`),n.model&&c.push(`Model: \`${n.model}\``),{content:c.join(`
`)}}catch(e){return{content:`Failed to get usage: ${String(e)}`}}}async function Am(e){try{let t=await e.request(`agents.list`,{}),n=t?.agents??[];if(n.length===0)return{content:`No agents configured.`};let r=[`**Agents** (${n.length})\n`];for(let e of n){let n=e.id===t?.defaultId,i=e.identity?.name||e.name||e.id,a=n?` *(default)*`:``;r.push(`- \`${e.id}\` — ${i}${a}`)}return{content:r.join(`
`)}}catch(e){return{content:`Failed to list agents: ${String(e)}`}}}async function jm(e,t,n){let r=n.trim();if(!r)return{content:"Usage: `/kill <id|all>`"};try{let n=Mm((await e.request(`sessions.list`,{}))?.sessions??[],t,r);if(n.length===0)return{content:r.toLowerCase()===`all`?`No active sub-agent sessions found.`:`No matching sub-agent sessions found for \`${r}\`.`};let i=await Promise.allSettled(n.map(t=>e.request(`chat.abort`,{sessionKey:t}))),a=i.filter(e=>e.status===`rejected`),o=i.filter(e=>e.status===`fulfilled`&&e.value?.aborted!==!1).length;if(o===0){if(a.length===0)return{content:r.toLowerCase()===`all`?`No active sub-agent runs to abort.`:`No active runs matched \`${r}\`.`};throw a[0]?.reason??Error(`abort failed`)}return r.toLowerCase()===`all`?{content:o===n.length?`Aborted ${o} sub-agent session${o===1?``:`s`}.`:`Aborted ${o} of ${n.length} sub-agent sessions.`}:{content:o===n.length?`Aborted ${o} matching sub-agent session${o===1?``:`s`} for \`${r}\`.`:`Aborted ${o} of ${n.length} matching sub-agent sessions for \`${r}\`.`}}catch(e){return{content:`Failed to abort: ${String(e)}`}}}function Mm(e,t,n){let r=n.trim().toLowerCase();if(!r)return[];let i=new Set,a=t.trim().toLowerCase(),o=tt(a)?.agentId??(a===`main`?`main`:void 0),s=Pm(e);for(let t of e){let e=t?.key?.trim();if(!e||!nt(e))continue;let n=e.toLowerCase(),c=tt(n),l=Nm(n,a,s,o,c?.agentId);(r===`all`&&l||l&&n===r||l&&((c?.agentId??``)===r||n.endsWith(`:subagent:${r}`)||n===`subagent:${r}`))&&i.add(e)}return[...i]}function Nm(e,t,n,r,i){if(!r||i!==r)return!1;let a=Im(t,r),o=new Set,s=Fm(n.get(e)?.spawnedBy);for(;s&&!o.has(s);){if(a.has(s))return!0;o.add(s),s=Fm(n.get(s)?.spawnedBy)}return nt(t)?e.startsWith(`${t}:subagent:`):!1}function Pm(e){let t=new Map;for(let n of e){let e=Fm(n?.key);e&&t.set(e,n)}return t}function Fm(e){return e?.trim().toLowerCase()||void 0}function Im(e,t){let n=new Set([e]);if(t===`main`){let t=`agent:${pm}:main`;e===`main`?n.add(t):e===t&&n.add(mm)}return n}function Lm(e,t){return`${e}\nOptions: ${t}.`}async function Rm(e,t){return zm(await e.request(`sessions.list`,{}),t)}function zm(e,t){let n=Fm(t),r=tt(n??``)?.agentId??(n===`main`?`main`:void 0),i=n?Im(n,r):new Set;return e?.sessions?.find(e=>{let t=Fm(e.key);return t?i.has(t):!1})}async function Bm(e,t){let[n,r]=await Promise.all([e.request(`sessions.list`,{}),e.request(`models.list`,{})]);return{session:zm(n,t),models:r?.models??[]}}function Vm(e,t){return am(e?.thinkingLevel)||(!e?.modelProvider||!e.model?`off`:um({provider:e.modelProvider,model:e.model,catalog:t}))}function Hm(e){return e?.fastMode===!0?`on`:`off`}function Um(e){return e>=1e6?`${(e/1e6).toFixed(1).replace(/\.0$/,``)}M`:e>=1e3?`${(e/1e3).toFixed(1).replace(/\.0$/,``)}k`:String(e)}var X={AUTH_REQUIRED:`AUTH_REQUIRED`,AUTH_UNAUTHORIZED:`AUTH_UNAUTHORIZED`,AUTH_TOKEN_MISSING:`AUTH_TOKEN_MISSING`,AUTH_TOKEN_MISMATCH:`AUTH_TOKEN_MISMATCH`,AUTH_TOKEN_NOT_CONFIGURED:`AUTH_TOKEN_NOT_CONFIGURED`,AUTH_PASSWORD_MISSING:`AUTH_PASSWORD_MISSING`,AUTH_PASSWORD_MISMATCH:`AUTH_PASSWORD_MISMATCH`,AUTH_PASSWORD_NOT_CONFIGURED:`AUTH_PASSWORD_NOT_CONFIGURED`,AUTH_BOOTSTRAP_TOKEN_INVALID:`AUTH_BOOTSTRAP_TOKEN_INVALID`,AUTH_DEVICE_TOKEN_MISMATCH:`AUTH_DEVICE_TOKEN_MISMATCH`,AUTH_RATE_LIMITED:`AUTH_RATE_LIMITED`,AUTH_TAILSCALE_IDENTITY_MISSING:`AUTH_TAILSCALE_IDENTITY_MISSING`,AUTH_TAILSCALE_PROXY_MISSING:`AUTH_TAILSCALE_PROXY_MISSING`,AUTH_TAILSCALE_WHOIS_FAILED:`AUTH_TAILSCALE_WHOIS_FAILED`,AUTH_TAILSCALE_IDENTITY_MISMATCH:`AUTH_TAILSCALE_IDENTITY_MISMATCH`,CONTROL_UI_ORIGIN_NOT_ALLOWED:`CONTROL_UI_ORIGIN_NOT_ALLOWED`,CONTROL_UI_DEVICE_IDENTITY_REQUIRED:`CONTROL_UI_DEVICE_IDENTITY_REQUIRED`,DEVICE_IDENTITY_REQUIRED:`DEVICE_IDENTITY_REQUIRED`,DEVICE_AUTH_INVALID:`DEVICE_AUTH_INVALID`,DEVICE_AUTH_DEVICE_ID_MISMATCH:`DEVICE_AUTH_DEVICE_ID_MISMATCH`,DEVICE_AUTH_SIGNATURE_EXPIRED:`DEVICE_AUTH_SIGNATURE_EXPIRED`,DEVICE_AUTH_NONCE_REQUIRED:`DEVICE_AUTH_NONCE_REQUIRED`,DEVICE_AUTH_NONCE_MISMATCH:`DEVICE_AUTH_NONCE_MISMATCH`,DEVICE_AUTH_SIGNATURE_INVALID:`DEVICE_AUTH_SIGNATURE_INVALID`,DEVICE_AUTH_PUBLIC_KEY_INVALID:`DEVICE_AUTH_PUBLIC_KEY_INVALID`,PAIRING_REQUIRED:`PAIRING_REQUIRED`},Wm=new Set([`retry_with_device_token`,`update_auth_configuration`,`update_auth_credentials`,`wait_then_retry`,`review_auth_configuration`]);function Gm(e){if(!e||typeof e!=`object`||Array.isArray(e))return null;let t=e.code;return typeof t==`string`&&t.trim().length>0?t:null}function Km(e){if(!e||typeof e!=`object`||Array.isArray(e))return{};let t=e,n=typeof t.canRetryWithDeviceToken==`boolean`?t.canRetryWithDeviceToken:void 0,r=typeof t.recommendedNextStep==`string`?t.recommendedNextStep.trim():``;return{canRetryWithDeviceToken:n,recommendedNextStep:Wm.has(r)?r:void 0}}function qm(e){let t=e.scopes.join(`,`),n=e.token??``;return[`v2`,e.deviceId,e.clientId,e.clientMode,e.role,t,String(e.signedAtMs),n,e.nonce].join(`|`)}var Jm={WEBCHAT_UI:`webchat-ui`,CONTROL_UI:`openclaw-control-ui`,WEBCHAT:`webchat`,CLI:`cli`,GATEWAY_CLIENT:`gateway-client`,MACOS_APP:`openclaw-macos`,IOS_APP:`openclaw-ios`,ANDROID_APP:`openclaw-android`,NODE_HOST:`node-host`,TEST:`test`,FINGERPRINT:`fingerprint`,PROBE:`openclaw-probe`},Ym=Jm,Xm={WEBCHAT:`webchat`,CLI:`cli`,UI:`ui`,BACKEND:`backend`,NODE:`node`,PROBE:`probe`,TEST:`test`};new Set(Object.values(Jm)),new Set(Object.values(Xm));var Zm=!1;function Qm(e){e[6]=e[6]&15|64,e[8]=e[8]&63|128;let t=``;for(let n=0;n<e.length;n++)t+=e[n].toString(16).padStart(2,`0`);return`${t.slice(0,8)}-${t.slice(8,12)}-${t.slice(12,16)}-${t.slice(16,20)}-${t.slice(20)}`}function $m(){let e=new Uint8Array(16),t=Date.now();for(let t=0;t<e.length;t++)e[t]=Math.floor(Math.random()*256);return e[0]^=t&255,e[1]^=t>>>8&255,e[2]^=t>>>16&255,e[3]^=t>>>24&255,e}function eh(){Zm||(Zm=!0,console.warn(`[uuid] crypto API missing; falling back to weak randomness`))}function th(e=globalThis.crypto){if(e&&typeof e.randomUUID==`function`)return e.randomUUID();if(e&&typeof e.getRandomValues==`function`){let t=new Uint8Array(16);return e.getRandomValues(t),Qm(t)}return eh(),Qm($m())}var nh=class extends Error{constructor(e){super(e.message),this.name=`GatewayRequestError`,this.gatewayCode=e.code,this.details=e.details}};function rh(e){return Gm(e?.details)}function ih(e){if(!e)return!1;let t=rh(e);return t===X.AUTH_TOKEN_MISSING||t===X.AUTH_BOOTSTRAP_TOKEN_INVALID||t===X.AUTH_PASSWORD_MISSING||t===X.AUTH_PASSWORD_MISMATCH||t===X.AUTH_RATE_LIMITED||t===X.PAIRING_REQUIRED||t===X.CONTROL_UI_DEVICE_IDENTITY_REQUIRED||t===X.DEVICE_IDENTITY_REQUIRED}function ah(e){try{let t=new URL(e,window.location.href),n=t.hostname.trim().toLowerCase(),r=n===`localhost`||n===`::1`||n===`[::1]`||n===`127.0.0.1`,i=n.startsWith(`127.`);if(r||i)return!0;let a=new URL(window.location.href);return t.host===a.host}catch{return!1}}var oh=4008,sh=class{constructor(e){this.opts=e,this.ws=null,this.pending=new Map,this.closed=!1,this.lastSeq=null,this.connectNonce=null,this.connectSent=!1,this.connectTimer=null,this.backoffMs=800,this.pendingDeviceTokenRetry=!1,this.deviceTokenRetryBudgetUsed=!1}start(){this.closed=!1,this.connect()}stop(){this.closed=!0,this.ws?.close(),this.ws=null,this.pendingConnectError=void 0,this.pendingDeviceTokenRetry=!1,this.deviceTokenRetryBudgetUsed=!1,this.flushPending(Error(`gateway client stopped`))}get connected(){return this.ws?.readyState===WebSocket.OPEN}connect(){this.closed||(this.ws=new WebSocket(this.opts.url),this.ws.addEventListener(`open`,()=>this.queueConnect()),this.ws.addEventListener(`message`,e=>this.handleMessage(String(e.data??``))),this.ws.addEventListener(`close`,e=>{let t=String(e.reason??``),n=this.pendingConnectError;this.pendingConnectError=void 0,this.ws=null,this.flushPending(Error(`gateway closed (${e.code}): ${t}`)),this.opts.onClose?.({code:e.code,reason:t,error:n}),!(rh(n)===X.AUTH_TOKEN_MISMATCH&&this.deviceTokenRetryBudgetUsed&&!this.pendingDeviceTokenRetry)&&(ih(n)||this.scheduleReconnect())}),this.ws.addEventListener(`error`,()=>{}))}scheduleReconnect(){if(this.closed)return;let e=this.backoffMs;this.backoffMs=Math.min(this.backoffMs*1.7,15e3),window.setTimeout(()=>this.connect(),e)}flushPending(e){for(let[,t]of this.pending)t.reject(e);this.pending.clear()}async sendConnect(){if(this.connectSent)return;this.connectSent=!0,this.connectTimer!==null&&(window.clearTimeout(this.connectTimer),this.connectTimer=null);let e=typeof crypto<`u`&&!!crypto.subtle,t=[`operator.admin`,`operator.approvals`,`operator.pairing`],n=`operator`,r=this.opts.token?.trim()||void 0,i=this.opts.password?.trim()||void 0,a=null,o={authToken:r,authPassword:i,canFallbackToShared:!1};e&&(a=await Kr(),o=this.selectConnectAuth({role:n,deviceId:a.deviceId}),this.pendingDeviceTokenRetry&&o.authDeviceToken&&(this.pendingDeviceTokenRetry=!1));let s=o.authToken,c=o.authDeviceToken??o.resolvedDeviceToken,l=s||o.authPassword?{token:s,deviceToken:c,password:o.authPassword}:void 0,u;if(e&&a){let e=Date.now(),r=this.connectNonce??``,i=qm({deviceId:a.deviceId,clientId:this.opts.clientName??Ym.CONTROL_UI,clientMode:this.opts.mode??Xm.WEBCHAT,role:n,scopes:t,signedAtMs:e,token:s??null,nonce:r}),o=await qr(a.privateKey,i);u={id:a.deviceId,publicKey:a.publicKey,signature:o,signedAt:e,nonce:r}}let d={minProtocol:3,maxProtocol:3,client:{id:this.opts.clientName??Ym.CONTROL_UI,version:this.opts.clientVersion??`control-ui`,platform:this.opts.platform??navigator.platform??`web`,mode:this.opts.mode??Xm.WEBCHAT,instanceId:this.opts.instanceId},role:n,scopes:t,device:u,caps:[`tool-events`],auth:l,userAgent:navigator.userAgent,locale:navigator.language};this.request(`connect`,d).then(e=>{this.pendingDeviceTokenRetry=!1,this.deviceTokenRetryBudgetUsed=!1,e?.auth?.deviceToken&&a&&jn({deviceId:a.deviceId,role:e.auth.role??n,token:e.auth.deviceToken,scopes:e.auth.scopes??[]}),this.backoffMs=800,this.opts.onHello?.(e)}).catch(e=>{let t=e instanceof nh?rh(e):null,i=e instanceof nh?Km(e.details):{},s=i.recommendedNextStep===`retry_with_device_token`,c=i.canRetryWithDeviceToken===!0||s||t===X.AUTH_TOKEN_MISMATCH;!this.deviceTokenRetryBudgetUsed&&!o.authDeviceToken&&r&&a&&o.storedToken&&c&&ah(this.opts.url)&&(this.pendingDeviceTokenRetry=!0,this.deviceTokenRetryBudgetUsed=!0),e instanceof nh?this.pendingConnectError={code:e.gatewayCode,message:e.message,details:e.details}:this.pendingConnectError=void 0,o.canFallbackToShared&&a&&t===X.AUTH_DEVICE_TOKEN_MISMATCH&&Mn({deviceId:a.deviceId,role:n}),this.ws?.close(oh,`connect failed`)})}handleMessage(e){let t;try{t=JSON.parse(e)}catch{return}let n=t;if(n.type===`event`){let e=t;if(e.event===`connect.challenge`){let t=e.payload,n=t&&typeof t.nonce==`string`?t.nonce:null;n&&(this.connectNonce=n,this.sendConnect());return}let n=typeof e.seq==`number`?e.seq:null;n!==null&&(this.lastSeq!==null&&n>this.lastSeq+1&&this.opts.onGap?.({expected:this.lastSeq+1,received:n}),this.lastSeq=n);try{this.opts.onEvent?.(e)}catch(e){console.error(`[gateway] event handler error:`,e)}return}if(n.type===`res`){let e=t,n=this.pending.get(e.id);if(!n)return;this.pending.delete(e.id),e.ok?n.resolve(e.payload):n.reject(new nh({code:e.error?.code??`UNAVAILABLE`,message:e.error?.message??`request failed`,details:e.error?.details}));return}}selectConnectAuth(e){let t=this.opts.token?.trim()||void 0,n=this.opts.password?.trim()||void 0,r=An({deviceId:e.deviceId,role:e.role})?.token,i=this.pendingDeviceTokenRetry&&!!t&&!!r&&ah(this.opts.url),a=t||n?void 0:r??void 0;return{authToken:t??a,authDeviceToken:i?r??void 0:void 0,authPassword:n,resolvedDeviceToken:a,storedToken:r??void 0,canFallbackToShared:!!(r&&t)}}request(e,t){if(!this.ws||this.ws.readyState!==WebSocket.OPEN)return Promise.reject(Error(`gateway not connected`));let n=th(),r={type:`req`,id:n,method:e,params:t},i=new Promise((e,t)=>{this.pending.set(n,{resolve:t=>e(t),reject:t})});return this.ws.send(JSON.stringify(r)),i}queueConnect(){this.connectNonce=null,this.connectSent=!1,this.connectTimer!==null&&window.clearTimeout(this.connectTimer),this.connectTimer=window.setTimeout(()=>{this.sendConnect()},750)}};function ch(e){return typeof e==`string`?e:e instanceof Error&&typeof e.message==`string`?e.message:`unknown error`}function lh(e){let t=ch(e.message);switch(rh(e)){case X.AUTH_TOKEN_MISMATCH:return`gateway token mismatch`;case X.AUTH_UNAUTHORIZED:return`gateway auth failed`;case X.AUTH_RATE_LIMITED:return`too many failed authentication attempts`;case X.PAIRING_REQUIRED:return`gateway pairing required`;case X.CONTROL_UI_DEVICE_IDENTITY_REQUIRED:return`device identity required (use HTTPS/localhost or allow insecure auth explicitly)`;case X.CONTROL_UI_ORIGIN_NOT_ALLOWED:return`origin not allowed (open the Control UI from the gateway host or allow it in gateway.controlUi.allowedOrigins)`;case X.AUTH_TOKEN_MISSING:return`gateway token missing`;default:break}let n=t.trim().toLowerCase();return n===`fetch failed`||n===`failed to fetch`||n===`connect failed`?`gateway connect failed`:t}function uh(e){return e&&typeof e==`object`?lh(e):ch(e)}var dh=/^\s*NO_REPLY\s*$/;function fh(e){return dh.test(e)}function ph(e){if(!e||typeof e!=`object`)return!1;let t=e;if((typeof t.role==`string`?t.role.toLowerCase():``)!==`assistant`)return!1;if(typeof t.text==`string`)return fh(t.text);let n=oo(e);return typeof n==`string`&&fh(n)}var mh=900,hh=3,gh=24,_h=220,vh=[{label:`Continue this task`,prompt:`Continue this task and focus on the next concrete step.`,kind:`continue`,confidence:.35,source:`fallback`},{label:`Break into steps`,prompt:`Break this task into clear implementation steps.`,kind:`plan`,confidence:.34,source:`fallback`},{label:`Inspect relevant code`,prompt:`Inspect the relevant code paths and identify what should change.`,kind:`inspect`,confidence:.33,source:`fallback`},{label:`Clarify expected outcome`,prompt:`Clarify the expected outcome and constraints before making changes.`,kind:`clarify`,confidence:.32,source:`fallback`},{label:`Review recent context`,prompt:`Review the recent context and identify the most relevant next step.`,kind:`continue`,confidence:.31,source:`fallback`},{label:`Propose implementation plan`,prompt:`Propose a concrete implementation plan for the current task.`,kind:`plan`,confidence:.3,source:`fallback`}],yh=new Map,bh=new WeakMap,xh=new WeakMap,Sh=new WeakMap,Ch=new Map;function wh(e){let t=e;t.toolStreamById instanceof Map&&Array.isArray(t.toolStreamOrder)&&Array.isArray(t.chatToolMessages)&&Array.isArray(t.chatStreamSegments)&&Kp(t)}function Th(e,t=e.chatMessage,n){let r=e.chatMessages.slice(-8).map(e=>{let t=e,n=typeof t?.role==`string`?t.role:`unknown`,r=oo(e);return`${n}:${typeof r==`string`?r.slice(0,280):``}`}).join(`
`),i=(n??e.chatSuggestionsSelectionText??``).trim();return[e.sessionKey,r,t.trim(),i].join(`
---
`)}function Eh(e){let t=e?.suggestions;return Array.isArray(t)?t.map(e=>{let t=typeof e?.label==`string`?e.label.trim():``,n=typeof e?.prompt==`string`?e.prompt.trim():``,r=typeof e?.kind==`string`?e.kind.trim():``,i=typeof e?.confidence==`number`&&Number.isFinite(e.confidence)?Math.max(0,Math.min(1,e.confidence)):.5;return!t||!n||![`continue`,`action`,`clarify`,`inspect`,`plan`].includes(r)?null:{label:t,prompt:n,kind:r,confidence:i,source:`ai`}}).filter(e=>e!==null).slice(0,hh):[]}function Dh(e,t,n){jh(e),n?.preserveCurrent&&e.chatSuggestions.length>0||(e.chatSuggestions=vh.slice(0,hh)),e.chatSuggestionsError=t??null,e.chatSuggestionsLoading=!1,e.chatSuggestionsSettling=!1,e.chatSuggestionsStale=!1,e.chatSuggestionsContextHint=null}function Oh(e,t){if(t.length===0)return;let n=Ch.get(e.sessionKey)??[],r=t.map(e=>e.label.trim()).filter(Boolean),i=[...n];for(let e of r)i.includes(e)||i.push(e);i.length>gh&&i.splice(0,i.length-gh),Ch.set(e.sessionKey,i)}function kh(e,t=!1){if(!t)return;let n=Ch.get(e.sessionKey)??[],r=e.chatSuggestions.map(e=>e.label.trim()).filter(Boolean),i=[...n];for(let e of r)i.includes(e)||i.push(e);if(i.length!==0)return i.slice(-gh)}function Ah(e){let t=bh.get(e);t!==void 0&&(clearTimeout(t),bh.delete(e))}function jh(e){let t=Sh.get(e);t!==void 0&&(clearTimeout(t),Sh.delete(e))}function Mh(e){jh(e),e.chatSuggestionsSettling=!0;let t=setTimeout(()=>{Sh.delete(e),e.chatSuggestionsSettling=!1},_h);Sh.set(e,t)}async function Nh(e,t){if(!e.client||!e.connected){Dh(e,void 0,{preserveCurrent:!0});return}jh(e);let n=t?.draft??e.chatMessage,r=(t?.selectionText??e.chatSuggestionsSelectionText??``).trim(),i=Th(e,n,r),a=yh.get(e.sessionKey);if(!t?.force&&a?.hash===i){e.chatSuggestions=a.suggestions,e.chatSuggestionsLoading=!1,e.chatSuggestionsSettling=!1,e.chatSuggestionsStale=!1,e.chatSuggestionsError=null,e.chatSuggestionsContextHint=r?`Based on selected text`:null;return}e.chatSuggestionsLoading=!0,e.chatSuggestionsSettling=!1,e.chatSuggestionsError=null;let o=th();xh.set(e,o);try{let a=kh(e,!!t?.force),s=t?.force?th():void 0,c=await e.client.request(`chat.suggestions`,{sessionKey:e.sessionKey,draft:n.trim()||void 0,selectionText:r||void 0,limit:hh,excludeLabels:a&&a.length>0?a:void 0,refreshNonce:s});if(xh.get(e)!==o)return;let l=Eh(c);if(l.length===0){Dh(e,`No suggestions available.`,{preserveCurrent:!0});return}yh.set(e.sessionKey,{hash:i,suggestions:l}),Oh(e,l),e.chatSuggestions=l,e.chatSuggestionsLoading=!1,Mh(e),e.chatSuggestionsStale=!1,e.chatSuggestionsContextHint=r?`Based on selected text`:null}catch(t){if(xh.get(e)!==o)return;Dh(e,uh(t),{preserveCurrent:!0})}}function Ph(e,t){if(!e.chatSuggestionsAutoRefresh){e.chatSuggestionsStale=!1;return}if(e.chatSending||e.chatRunId){e.chatSuggestionsStale=!0;return}e.chatSuggestionsStale=!0,Ah(e);let n=setTimeout(()=>{bh.delete(e),Nh(e,t)},mh);bh.set(e,n)}async function Fh(e){if(!(!e.client||!e.connected)){e.chatLoading=!0,e.lastError=null;try{let t=await e.client.request(`chat.history`,{sessionKey:e.sessionKey,limit:200});e.chatMessages=(Array.isArray(t.messages)?t.messages:[]).filter(e=>!ph(e)),e.chatThinkingLevel=t.thinkingLevel??null,wh(e),e.chatStream=null,e.chatStreamStartedAt=null,e.chatSuggestionsSettling=!1,Ph(e,{force:!0})}catch(t){e.lastError=String(t),Dh(e,String(t))}finally{e.chatLoading=!1}}}function Ih(e){let t=/^data:([^;]+);base64,(.+)$/.exec(e);return t?{mimeType:t[1],content:t[2]}:null}function Lh(e,t){if(!e||typeof e!=`object`)return null;let n=e,r=n.role;if(typeof r==`string`){if((t.roleCaseSensitive?r:r.toLowerCase())!==`assistant`)return null}else if(t.roleRequirement===`required`)return null;return t.requireContentArray?Array.isArray(n.content)?n:null:!(`content`in n)&&!(t.allowTextField&&`text`in n)?null:n}function Rh(e){return Lh(e,{roleRequirement:`required`,roleCaseSensitive:!0,requireContentArray:!0})}function zh(e){return Lh(e,{roleRequirement:`optional`,allowTextField:!0})}async function Bh(e,t,n){if(!e.client||!e.connected)return null;let r=t.trim(),i=n&&n.length>0;if(!r&&!i)return null;let a=Date.now(),o=[];if(r&&o.push({type:`text`,text:r}),i)for(let e of n)o.push({type:`image`,source:{type:`base64`,media_type:e.mimeType,data:e.dataUrl}});e.chatMessages=[...e.chatMessages,{role:`user`,content:o,timestamp:a}],e.chatSending=!0,e.lastError=null;let s=th();e.chatRunId=s,e.chatStream=``,e.chatStreamStartedAt=a,Ph(e,{force:!0,draft:r});let c=i?n.map(e=>{let t=Ih(e.dataUrl);return t?{type:`image`,mimeType:t.mimeType,content:t.content}:null}).filter(e=>e!==null):void 0;try{return await e.client.request(`chat.send`,{sessionKey:e.sessionKey,message:r,deliver:!1,idempotencyKey:s,attachments:c}),s}catch(t){let n=uh(t);return e.chatRunId=null,e.chatStream=null,e.chatStreamStartedAt=null,e.lastError=n,e.chatMessages=[...e.chatMessages,{role:`assistant`,content:[{type:`text`,text:`Error: `+n}],timestamp:Date.now()}],null}finally{e.chatSending=!1}}async function Vh(e){if(!e.client||!e.connected)return!1;let t=e.chatRunId;try{return await e.client.request(`chat.abort`,t?{sessionKey:e.sessionKey,runId:t}:{sessionKey:e.sessionKey}),!0}catch(t){return e.lastError=uh(t),!1}}function Hh(e,t){if(!t||t.sessionKey!==e.sessionKey)return null;if(t.runId&&e.chatRunId&&t.runId!==e.chatRunId){if(t.state===`final`){let n=zh(t.message);return n&&!ph(n)?(e.chatMessages=[...e.chatMessages,n],null):`final`}return null}if(t.state===`delta`){let n=oo(t.message);if(typeof n==`string`&&!fh(n)){let t=e.chatStream??``;(!t||n.length>=t.length)&&(e.chatStream=n)}}else if(t.state===`final`){let n=zh(t.message);n&&!ph(n)?e.chatMessages=[...e.chatMessages,n]:e.chatStream?.trim()&&!fh(e.chatStream)&&(e.chatMessages=[...e.chatMessages,{role:`assistant`,content:[{type:`text`,text:e.chatStream}],timestamp:Date.now()}]),e.chatStream=null,e.chatRunId=null,e.chatStreamStartedAt=null,Ph(e,{force:!0})}else if(t.state===`aborted`){let n=Rh(t.message);if(n&&!ph(n))e.chatMessages=[...e.chatMessages,n];else{let t=e.chatStream??``;t.trim()&&!fh(t)&&(e.chatMessages=[...e.chatMessages,{role:`assistant`,content:[{type:`text`,text:t}],timestamp:Date.now()}])}e.chatStream=null,e.chatRunId=null,e.chatStreamStartedAt=null,Ph(e,{force:!0})}else t.state===`error`&&(e.chatStream=null,e.chatRunId=null,e.chatStreamStartedAt=null,e.lastError=t.errorMessage??`chat error`,Dh(e,e.lastError));return t.state}async function Uh(e){try{return(await e.request(`models.list`,{}))?.models??[]}catch{return[]}}function Wh(e){return e.chatSending||!!e.chatRunId}function Gh(e){let t=e.trim();if(!t)return!1;let n=t.toLowerCase();return n===`/stop`?!0:n===`stop`||n===`esc`||n===`abort`||n===`wait`||n===`exit`}function Kh(e){let t=e.trim();if(!t)return!1;let n=t.toLowerCase();return n===`/new`||n===`/reset`?!0:n.startsWith(`/new `)||n.startsWith(`/reset `)}async function qh(e){e.connected&&(e.chatMessage=``,await Vh(e))}function Jh(e,t,n,r,i){let a=t.trim(),o=!!(n&&n.length>0);!a&&!o||(e.chatQueue=[...e.chatQueue,{id:th(),text:a,createdAt:Date.now(),attachments:o?n?.map(e=>({...e})):void 0,refreshSessions:r,localCommandArgs:i?.args,localCommandName:i?.name}])}async function Yh(e,t,n){Kp(e);let r=await Bh(e,t,n?.attachments),i=!!r;return!i&&n?.previousDraft!=null&&(e.chatMessage=n.previousDraft),!i&&n?.previousAttachments&&(e.chatAttachments=n.previousAttachments),i&&sp(e,e.sessionKey),i&&n?.restoreDraft&&n.previousDraft?.trim()&&(e.chatMessage=n.previousDraft),i&&n?.restoreAttachments&&n.previousAttachments?.length&&(e.chatAttachments=n.previousAttachments),it(e),i&&!e.chatRunId&&Xh(e),i&&n?.refreshSessions&&r&&e.refreshSessionsAfterChat.add(r),i}async function Xh(e){if(!e.connected||Wh(e))return;let[t,...n]=e.chatQueue;if(!t)return;e.chatQueue=n;let r=!1;try{t.localCommandName?(await eg(e,t.localCommandName,t.localCommandArgs??``),r=!0):r=await Yh(e,t.text,{attachments:t.attachments,refreshSessions:t.refreshSessions})}catch(t){e.lastError=String(t)}r?e.chatQueue.length>0&&Xh(e):e.chatQueue=[t,...e.chatQueue]}function Zh(e,t){e.chatQueue=e.chatQueue.filter(e=>e.id!==t)}async function Qh(e,t,n){if(!e.connected)return;let r=e.chatMessage,i=(t??e.chatMessage).trim(),a=e.chatAttachments??[],o=t==null?a:[],s=o.length>0;if(!i&&!s)return;if(Gh(i)){await qh(e);return}let c=mf(i);if(c?.command.executeLocal){if(Wh(e)&&$h(c.command.name)){t??(e.chatMessage=``,e.chatAttachments=[]),Jh(e,i,void 0,Kh(i),{args:c.args,name:c.command.name});return}let a=t==null?r:void 0;t??(e.chatMessage=``,e.chatAttachments=[]),await eg(e,c.command.name,c.args,{previousDraft:a,restoreDraft:!!(t&&n?.restoreDraft)});return}let l=Kh(i);if(t??(e.chatMessage=``,e.chatAttachments=[]),Wh(e)){Jh(e,i,o,l);return}await Yh(e,i,{previousDraft:t==null?r:void 0,restoreDraft:!!(t&&n?.restoreDraft),attachments:s?o:void 0,previousAttachments:t==null?a:void 0,restoreAttachments:!!(t&&n?.restoreDraft),refreshSessions:l})}function $h(e){return![`stop`,`focus`,`export`].includes(e)}async function eg(e,t,n,r){switch(t){case`stop`:await qh(e);return;case`new`:await Yh(e,`/new`,{refreshSessions:!0,previousDraft:r?.previousDraft,restoreDraft:r?.restoreDraft});return;case`reset`:await Yh(e,`/reset`,{refreshSessions:!0,previousDraft:r?.previousDraft,restoreDraft:r?.restoreDraft});return;case`clear`:await tg(e);return;case`focus`:e.onSlashAction?.(`toggle-focus`);return;case`export`:e.onSlashAction?.(`export`);return}if(!e.client)return;let i=e.sessionKey,a=await Sm(e.client,i,t,n);a.content&&ng(e,a.content),a.sessionPatch&&`model`in a.sessionPatch&&(e.chatModelOverrides={...e.chatModelOverrides,[i]:a.sessionPatch.model??null}),a.action===`refresh`&&await rg(e),it(e)}async function tg(e){if(!(!e.client||!e.connected)){try{await e.client.request(`sessions.reset`,{key:e.sessionKey}),e.chatMessages=[],e.chatStream=null,e.chatRunId=null,await Fh(e)}catch(t){e.lastError=String(t)}it(e)}}function ng(e,t){e.chatMessages=[...e.chatMessages,{role:`system`,content:t,timestamp:Date.now()}]}async function rg(e,t){await Promise.all([Fh(e),si(e,{activeMinutes:0,limit:0,includeGlobal:!0,includeUnknown:!0}),cg(e),ig(e)]),t?.scheduleScroll!==!1&&it(e)}async function ig(e){if(!e.client||!e.connected){e.chatModelsLoading=!1,e.chatModelCatalog=[];return}e.chatModelsLoading=!0;try{e.chatModelCatalog=await Uh(e.client)}finally{e.chatModelsLoading=!1}}var ag=Xh;function og(e){let t=tt(e.sessionKey);return t?.agentId?t.agentId:(e.hello?.snapshot)?.sessionDefaults?.defaultAgentId?.trim()||`main`}function sg(e,t){let n=Hi(e),r=encodeURIComponent(t);return n?`${n}/avatar/${r}?meta=1`:`avatar/${r}?meta=1`}async function cg(e){if(!e.connected){e.chatAvatarUrl=null;return}let t=og(e);if(!t){e.chatAvatarUrl=null;return}e.chatAvatarUrl=null;let n=sg(e.basePath,t);try{let t=await fetch(n,{method:`GET`});if(!t.ok){e.chatAvatarUrl=null;return}let r=await t.json();e.chatAvatarUrl=(typeof r.avatarUrl==`string`?r.avatarUrl.trim():``)||null}catch{e.chatAvatarUrl=null}}function lg(e){if(!e||e.state!==`final`)return!1;if(!e.message||typeof e.message!=`object`)return!0;let t=e.message,n=typeof t.role==`string`?t.role.toLowerCase():``;return!!(n&&n!==`assistant`)}function ug(e,t){if(typeof e!=`string`)return;let n=e.trim();if(n)return n.length<=t?n:n.slice(0,t)}var dg=50,fg=200;function pg(e){let t=ug(e?.name,dg)??`Assistant`,n=ug(e?.avatar??void 0,fg)??null;return{agentId:typeof e?.agentId==`string`&&e.agentId.trim()?e.agentId.trim():null,name:t,avatar:n}}async function mg(e,t){if(!e.client||!e.connected)return;let n=t?.sessionKey?.trim()||e.sessionKey.trim(),r=n?{sessionKey:n}:{};try{let t=await e.client.request(`agent.identity.get`,r);if(!t)return;let n=pg(t);e.assistantName=n.name,e.assistantAvatar=n.avatar,e.assistantAgentId=n.agentId??null}catch{}}function hg(e){return typeof e==`object`&&!!e}function gg(e){if(!hg(e))return null;let t=typeof e.id==`string`?e.id.trim():``,n=e.request;if(!t||!hg(n))return null;let r=typeof n.command==`string`?n.command.trim():``;if(!r)return null;let i=typeof e.createdAtMs==`number`?e.createdAtMs:0,a=typeof e.expiresAtMs==`number`?e.expiresAtMs:0;return!i||!a?null:{id:t,request:{command:r,cwd:typeof n.cwd==`string`?n.cwd:null,host:typeof n.host==`string`?n.host:null,security:typeof n.security==`string`?n.security:null,ask:typeof n.ask==`string`?n.ask:null,agentId:typeof n.agentId==`string`?n.agentId:null,resolvedPath:typeof n.resolvedPath==`string`?n.resolvedPath:null,sessionKey:typeof n.sessionKey==`string`?n.sessionKey:null},createdAtMs:i,expiresAtMs:a}}function _g(e){if(!hg(e))return null;let t=typeof e.id==`string`?e.id.trim():``;return t?{id:t,decision:typeof e.decision==`string`?e.decision:null,resolvedBy:typeof e.resolvedBy==`string`?e.resolvedBy:null,ts:typeof e.ts==`number`?e.ts:null}:null}function vg(e){let t=Date.now();return e.filter(e=>e.expiresAtMs>t)}function yg(e,t){let n=vg(e).filter(e=>e.id!==t.id);return n.push(t),n}function bg(e,t){return vg(e).filter(e=>e.id!==t)}var xg={ok:!1,ts:0,durationMs:0,heartbeatSeconds:0,defaultAgentId:``,agents:[],sessions:{path:``,count:0,recent:[]}};async function Sg(e){try{return await e.request(`health`,{})??xg}catch{return xg}}async function Cg(e){if(!(!e.client||!e.connected)&&!e.healthLoading){e.healthLoading=!0,e.healthError=null;try{e.healthResult=await Sg(e.client)}catch(t){e.healthError=String(t)}finally{e.healthLoading=!1}}}function wg(e){return/^(?:typeerror:\s*)?(?:fetch failed|failed to fetch)$/i.test(e.trim())}function Tg(e){let t=e.serverVersion?.trim();if(!t)return;let n=e.pageUrl??(typeof window>`u`?void 0:window.location.href);if(n)try{let r=new URL(n),i=new URL(e.gatewayUrl,r);return!new Set([`ws:`,`wss:`,`http:`,`https:`]).has(i.protocol)||i.host!==r.host?void 0:t}catch{return}}function Eg(e,t){let n=(e??``).trim(),r=t.mainSessionKey?.trim();if(!r)return n;if(!n)return r;let i=t.mainKey?.trim()||`main`,a=t.defaultAgentId?.trim();return n===`main`||n===i||a&&(n===`agent:${a}:main`||n===`agent:${a}:${i}`)?r:n}function Dg(e,t){if(!t?.mainSessionKey)return;let n=Eg(e.sessionKey,t),r=Eg(e.settings.sessionKey,t),i=Eg(e.settings.lastActiveSessionKey,t),a=n||r||e.sessionKey,o={...e.settings,sessionKey:r||a,lastActiveSessionKey:i||a},s=o.sessionKey!==e.settings.sessionKey||o.lastActiveSessionKey!==e.settings.lastActiveSessionKey;a!==e.sessionKey&&(e.sessionKey=a),s&&op(e,o)}function Og(e){e.lastError=null,e.lastErrorCode=null,e.hello=null,e.connected=!1,e.execApprovalQueue=[],e.execApprovalError=null;let t=e.client,n=Tg({gatewayUrl:e.settings.gatewayUrl,serverVersion:e.serverVersion}),r=new sh({url:e.settings.gatewayUrl,token:e.settings.token.trim()?e.settings.token:void 0,password:e.password.trim()?e.password:void 0,clientName:`openclaw-control-ui`,clientVersion:n,mode:`webchat`,instanceId:e.clientInstanceId,onHello:t=>{e.client===r&&(e.connected=!0,e.lastError=null,e.lastErrorCode=null,e.hello=t,Ng(e,t),e.chatRunId=null,e.chatStream=null,e.chatStreamStartedAt=null,Kp(e),mg(e),Lt(e),Cg(e),Dt(e,{quiet:!0}),Jr(e,{quiet:!0}),fp(e))},onClose:({code:t,reason:n,error:i})=>{if(e.client===r)if(e.connected=!1,e.lastErrorCode=rh(i)??(typeof i?.code==`string`?i.code:null),t!==1012){if(i?.message){e.lastError=e.lastErrorCode&&wg(i.message)?uh({message:i.message,details:i.details,code:i.code}):i.message;return}e.lastError=`disconnected (${t}): ${n||`no reason`}`}else e.lastError=null,e.lastErrorCode=null},onEvent:t=>{e.client===r&&kg(e,t)},onGap:({expected:t,received:n})=>{e.client===r&&(e.lastError=`event gap detected (expected seq ${t}, got ${n}); refresh recommended`,e.lastErrorCode=null)}});e.client=r,t?.stop(),r.start()}function kg(e,t){try{Mg(e,t)}catch(e){console.error(`[gateway] handleGatewayEvent error:`,t.event,e)}}function Ag(e,t,n){if(n!==`final`&&n!==`error`&&n!==`aborted`)return!1;let r=e,i=r.toolStreamOrder.length>0;Kp(r),ag(e);let a=t?.runId;return a&&e.refreshSessionsAfterChat.has(a)&&(e.refreshSessionsAfterChat.delete(a),n===`final`&&si(e,{activeMinutes:120})),i&&n===`final`?(Fh(e),!0):!1}function jg(e,t){t?.sessionKey&&sp(e,t.sessionKey);let n=Hh(e,t),r=Ag(e,t,n);n===`final`&&!r&&lg(t)&&Fh(e)}function Mg(e,t){if(e.eventLogBuffer=[{ts:Date.now(),event:t.event,payload:t.payload},...e.eventLogBuffer].slice(0,250),(e.tab===`debug`||e.tab===`overview`)&&(e.eventLog=e.eventLogBuffer),t.event===`agent`){if(e.onboarding)return;Qp(e,t.payload);return}if(t.event===`chat`){jg(e,t.payload);return}if(t.event===`presence`){let n=t.payload;n?.presence&&Array.isArray(n.presence)&&(e.presenceEntries=n.presence,e.presenceError=null,e.presenceStatus=null);return}if(t.event===`cron`&&e.tab===`cron`&&jp(e),(t.event===`device.pair.requested`||t.event===`device.pair.resolved`)&&Jr(e,{quiet:!0}),t.event===`exec.approval.requested`){let n=gg(t.payload);if(n){e.execApprovalQueue=yg(e.execApprovalQueue,n),e.execApprovalError=null;let t=Math.max(0,n.expiresAtMs-Date.now()+500);window.setTimeout(()=>{e.execApprovalQueue=bg(e.execApprovalQueue,n.id)},t)}return}if(t.event===`exec.approval.resolved`){let n=_g(t.payload);n&&(e.execApprovalQueue=bg(e.execApprovalQueue,n.id));return}t.event===`update.available`&&(e.updateAvailable=t.payload?.updateAvailable??null)}function Ng(e,t){let n=t.snapshot;n?.presence&&Array.isArray(n.presence)&&(e.presenceEntries=n.presence),n?.health&&(e.debugHealth=n.health,e.healthResult=n.health),n?.sessionDefaults&&Dg(e,n.sessionDefaults),e.updateAvailable=n?.updateAvailable??null}var Pg=`/__openclaw/control-ui-config.json`;async function Fg(e){if(typeof window>`u`||typeof fetch!=`function`)return;let t=Hi(e.basePath??``),n=t?`${t}${Pg}`:Pg;try{let t=await fetch(n,{method:`GET`,headers:{Accept:`application/json`},credentials:`same-origin`});if(!t.ok)return;let r=await t.json(),i=pg({agentId:r.assistantAgentId??null,name:r.assistantName,avatar:r.assistantAvatar??null});e.assistantName=i.name,e.assistantAvatar=i.avatar,e.assistantAgentId=i.agentId??null,e.serverVersion=r.serverVersion??null}catch{}}function Ig(e){let t=++e.connectGeneration;e.basePath=pp(),cp(e);let n=Fg(e);yp(e,!0),mp(e),hp(e),window.addEventListener(`popstate`,e.popStateHandler),n.finally(()=>{e.connectGeneration===t&&Og(e)}),Ot(e),e.tab===`logs`&&At(e),e.tab===`debug`&&Mt(e)}function Lg(e){ut(e)}function Rg(e){e.connectGeneration+=1,window.removeEventListener(`popstate`,e.popStateHandler),kt(e),jt(e),Nt(e),e.client?.stop(),e.client=null,e.connected=!1,gp(e),e.topbarObserver?.disconnect(),e.topbarObserver=null}function zg(e,t){if(!(e.tab===`chat`&&e.chatManualRefreshInFlight)){if(e.tab===`chat`&&(t.has(`chatMessages`)||t.has(`chatToolMessages`)||t.has(`chatStream`)||t.has(`chatLoading`)||t.has(`tab`))){let n=t.has(`tab`),r=t.has(`chatLoading`)&&t.get(`chatLoading`)===!0&&!e.chatLoading;it(e,n||r||!e.chatHasAutoScrolled)}e.tab===`logs`&&(t.has(`logsEntries`)||t.has(`logsAutoFollow`)||t.has(`tab`))&&e.logsAutoFollow&&e.logsAtBottom&&at(e,t.has(`tab`)||t.has(`logsAutoFollow`))}}var Bg=new Set([`agent`,`channel`,`chat`,`provider`,`model`,`tool`,`label`,`key`,`session`,`id`,`has`,`mintokens`,`maxtokens`,`mincost`,`maxcost`,`minmessages`,`maxmessages`]),Vg=e=>e.trim().toLowerCase(),Hg=e=>{let t=e.replace(/[.+^${}()|[\]\\]/g,`\\$&`).replace(/\*/g,`.*`).replace(/\?/g,`.`);return RegExp(`^${t}$`,`i`)},Ug=e=>{let t=e.trim().toLowerCase();if(!t)return null;t.startsWith(`$`)&&(t=t.slice(1));let n=1;t.endsWith(`k`)?(n=1e3,t=t.slice(0,-1)):t.endsWith(`m`)&&(n=1e6,t=t.slice(0,-1));let r=Number(t);return Number.isFinite(r)?r*n:null},Wg=e=>(e.match(/"[^"]+"|\S+/g)??[]).map(e=>{let t=e.replace(/^"|"$/g,``),n=t.indexOf(`:`);return n>0?{key:t.slice(0,n),value:t.slice(n+1),raw:t}:{value:t,raw:t}}),Gg=e=>[e.label,e.key,e.sessionId].filter(e=>!!e).map(e=>e.toLowerCase()),Kg=e=>{let t=new Set;e.modelProvider&&t.add(e.modelProvider.toLowerCase()),e.providerOverride&&t.add(e.providerOverride.toLowerCase()),e.origin?.provider&&t.add(e.origin.provider.toLowerCase());for(let n of e.usage?.modelUsage??[])n.provider&&t.add(n.provider.toLowerCase());return Array.from(t)},qg=e=>{let t=new Set;e.model&&t.add(e.model.toLowerCase());for(let n of e.usage?.modelUsage??[])n.model&&t.add(n.model.toLowerCase());return Array.from(t)},Jg=e=>(e.usage?.toolUsage?.tools??[]).map(e=>e.name.toLowerCase()),Yg=(e,t)=>{let n=Vg(t.value??``);if(!n)return!0;if(!t.key)return Gg(e).some(e=>e.includes(n));switch(Vg(t.key)){case`agent`:return e.agentId?.toLowerCase().includes(n)??!1;case`channel`:return e.channel?.toLowerCase().includes(n)??!1;case`chat`:return e.chatType?.toLowerCase().includes(n)??!1;case`provider`:return Kg(e).some(e=>e.includes(n));case`model`:return qg(e).some(e=>e.includes(n));case`tool`:return Jg(e).some(e=>e.includes(n));case`label`:return e.label?.toLowerCase().includes(n)??!1;case`key`:case`session`:case`id`:if(n.includes(`*`)||n.includes(`?`)){let t=Hg(n);return t.test(e.key)||(e.sessionId?t.test(e.sessionId):!1)}return e.key.toLowerCase().includes(n)||(e.sessionId?.toLowerCase().includes(n)??!1);case`has`:switch(n){case`tools`:return(e.usage?.toolUsage?.totalCalls??0)>0;case`errors`:return(e.usage?.messageCounts?.errors??0)>0;case`context`:return!!e.contextWeight;case`usage`:return!!e.usage;case`model`:return qg(e).length>0;case`provider`:return Kg(e).length>0;default:return!0}case`mintokens`:{let t=Ug(n);return t===null?!0:(e.usage?.totalTokens??0)>=t}case`maxtokens`:{let t=Ug(n);return t===null?!0:(e.usage?.totalTokens??0)<=t}case`mincost`:{let t=Ug(n);return t===null?!0:(e.usage?.totalCost??0)>=t}case`maxcost`:{let t=Ug(n);return t===null?!0:(e.usage?.totalCost??0)<=t}case`minmessages`:{let t=Ug(n);return t===null?!0:(e.usage?.messageCounts?.total??0)>=t}case`maxmessages`:{let t=Ug(n);return t===null?!0:(e.usage?.messageCounts?.total??0)<=t}default:return!0}},Xg=(e,t)=>{let n=Wg(t);if(n.length===0)return{sessions:e,warnings:[]};let r=[];for(let e of n){if(!e.key)continue;let t=Vg(e.key);if(!Bg.has(t)){r.push(`Unknown filter: ${e.key}`);continue}if(e.value===``&&r.push(`Missing value for ${e.key}`),t===`has`){let t=new Set([`tools`,`errors`,`context`,`usage`,`model`,`provider`]);e.value&&!t.has(Vg(e.value))&&r.push(`Unknown has:${e.value}`)}[`mintokens`,`maxtokens`,`mincost`,`maxcost`,`minmessages`,`maxmessages`].includes(t)&&e.value&&Ug(e.value)===null&&r.push(`Invalid number for ${e.key}`)}return{sessions:e.filter(e=>n.every(t=>Yg(e,t))),warnings:r}};function Zg(e){let t=e.split(`
...
`).trim()}}function Qg(e,t){!t||t.count<=0||(e.count+=t.count,e.sum+=t.avgMs*t.count,e.min=Math.min(e.min,t.minMs),e.max=Math.max(e.max,t.maxMs),e.p95Max=Math.max(e.p95Max,t.p95Ms))}function $g(e,t){for(let n of t??[]){let t=e.get(n.date)??{date:n.date,count:0,sum:0,min:1/0,max:0,p95Max:0};t.count+=n.count,t.sum+=n.avgMs*n.count,t.min=Math.min(t.min,n.minMs),t.max=Math.max(t.max,n.maxMs),t.p95Max=Math.max(t.p95Max,n.p95Ms),e.set(n.date,t)}}function e_(e){return{byChannel:Array.from(e.byChannelMap.entries()).map(([e,t])=>({channel:e,totals:t})).toSorted((e,t)=>t.totals.totalCost-e.totals.totalCost),latency:e.latencyTotals.count>0?{count:e.latencyTotals.count,avgMs:e.latencyTotals.sum/e.latencyTotals.count,minMs:e.latencyTotals.min===1/0?0:e.latencyTotals.min,maxMs:e.latencyTotals.max,p95Ms:e.latencyTotals.p95Max}:void 0,dailyLatency:Array.from(e.dailyLatencyMap.values()).map(e=>({date:e.date,count:e.count,avgMs:e.count?e.sum/e.count:0,minMs:e.min===1/0?0:e.min,maxMs:e.max,p95Ms:e.p95Max})).toSorted((e,t)=>e.date.localeCompare(t.date)),modelDaily:Array.from(e.modelDailyMap.values()).toSorted((e,t)=>e.date.localeCompare(t.date)||t.cost-e.cost),daily:Array.from(e.dailyMap.values()).toSorted((e,t)=>e.date.localeCompare(t.date))}}var t_=4;function n_(e){return Math.round(e/t_)}function Z(e){return e>=1e6?`${(e/1e6).toFixed(1)}M`:e>=1e3?`${(e/1e3).toFixed(1)}K`:String(e)}function r_(e){let t=new Date;return t.setHours(e,0,0,0),t.toLocaleTimeString(void 0,{hour:`numeric`})}function i_(e,t){let n=Array.from({length:24},()=>0),r=Array.from({length:24},()=>0);for(let i of e){let e=i.usage;if(!e?.messageCounts||e.messageCounts.total===0)continue;let a=e.firstActivity??i.updatedAt,o=e.lastActivity??i.updatedAt;if(!a||!o)continue;let s=Math.min(a,o),c=Math.max(a,o),l=Math.max(c-s,1)/6e4,u=s;for(;u<c;){let i=new Date(u),a=o_(i,t),o=c_(i,t),s=Math.min(o.getTime(),c),d=Math.max((s-u)/6e4,0)/l;n[a]+=e.messageCounts.errors*d,r[a]+=e.messageCounts.total*d,u=s+1}}return r.map((e,t)=>{let r=n[t];return{hour:t,rate:e>0?r/e:0,errors:r,msgs:e}}).filter(e=>e.msgs>0&&e.errors>0).toSorted((e,t)=>t.rate-e.rate).slice(0,5).map(e=>({label:r_(e.hour),value:`${(e.rate*100).toFixed(2)}%`,sub:`${Math.round(e.errors)} errors · ${Math.round(e.msgs)} msgs`}))}var a_=[`Sun`,`Mon`,`Tue`,`Wed`,`Thu`,`Fri`,`Sat`];function o_(e,t){return t===`utc`?e.getUTCHours():e.getHours()}function s_(e,t){return t===`utc`?e.getUTCDay():e.getDay()}function c_(e,t){let n=new Date(e);return t===`utc`?n.setUTCMinutes(59,59,999):n.setMinutes(59,59,999),n}function l_(e,t){let n=Array.from({length:24},()=>0),r=Array.from({length:7},()=>0),i=0,a=!1;for(let o of e){let e=o.usage;if(!e||!e.totalTokens||e.totalTokens<=0)continue;i+=e.totalTokens;let s=e.firstActivity??o.updatedAt,c=e.lastActivity??o.updatedAt;if(!s||!c)continue;a=!0;let l=Math.min(s,c),u=Math.max(s,c),d=Math.max(u-l,1)/6e4,f=l;for(;f<u;){let i=new Date(f),a=o_(i,t),o=s_(i,t),s=c_(i,t),c=Math.min(s.getTime(),u),l=Math.max((c-f)/6e4,0)/d;n[a]+=e.totalTokens*l,r[o]+=e.totalTokens*l,f=c+1}}let o=a_.map((e,t)=>({label:e,tokens:r[t]}));return{hasData:a,totalTokens:i,hourTotals:n,weekdayTotals:o}}function u_(e,t,r,i){let a=l_(e,t);if(!a.hasData)return n`
  ...
  `}function Q(e,t=2){return`$${e.toFixed(t)}`}function d_(e){return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`}function f_(e){let t=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!t)return null;let[,n,r,i]=t,a=new Date(Date.UTC(Number(n),Number(r)-1,Number(i)));return Number.isNaN(a.valueOf())?null:a}function p_(e){let t=f_(e);return t?t.toLocaleDateString(void 0,{month:`short`,day:`numeric`}):e}function m_(e){let t=f_(e);return t?t.toLocaleDateString(void 0,{month:`long`,day:`numeric`,year:`numeric`}):e}var h_=()=>({input:0,output:0,cacheRead:0,cacheWrite:0,totalTokens:0,totalCost:0,inputCost:0,outputCost:0,cacheReadCost:0,cacheWriteCost:0,missingCostEntries:0}),g_=(e,t)=>{e.input+=t.input??0,e.output+=t.output??0,e.cacheRead+=t.cacheRead??0,e.cacheWrite+=t.cacheWrite??0,e.totalTokens+=t.totalTokens??0,e.totalCost+=t.totalCost??0,e.inputCost+=t.inputCost??0,e.outputCost+=t.outputCost??0,e.cacheReadCost+=t.cacheReadCost??0,e.cacheWriteCost+=t.cacheWriteCost??0,e.missingCostEntries+=t.missingCostEntries??0},__=(e,t)=>{if(e.length===0)return t??{messages:{total:0,user:0,assistant:0,toolCalls:0,toolResults:0,errors:0},tools:{totalCalls:0,uniqueTools:0,tools:[]},byModel:[],byProvider:[],byAgent:[],byChannel:[],daily:[]};let n={total:0,user:0,assistant:0,toolCalls:0,toolResults:0,errors:0},r=new Map,i=new Map,a=new Map,o=new Map,s=new Map,c=new Map,l=new Map,u=new Map,d={count:0,sum:0,min:1/0,max:0,p95Max:0};for(let t of e){let e=t.usage;if(e){if(e.messageCounts&&(n.total+=e.messageCounts.total,n.user+=e.messageCounts.user,n.assistant+=e.messageCounts.assistant,n.toolCalls+=e.messageCounts.toolCalls,n.toolResults+=e.messageCounts.toolResults,n.errors+=e.messageCounts.errors),e.toolUsage)for(let t of e.toolUsage.tools)r.set(t.name,(r.get(t.name)??0)+t.count);if(e.modelUsage)for(let t of e.modelUsage){let e=`${t.provider??`unknown`}::${t.model??`unknown`}`,n=i.get(e)??{provider:t.provider,model:t.model,count:0,totals:h_()};n.count+=t.count,g_(n.totals,t.totals),i.set(e,n);let r=t.provider??`unknown`,o=a.get(r)??{provider:t.provider,model:void 0,count:0,totals:h_()};o.count+=t.count,g_(o.totals,t.totals),a.set(r,o)}if(Qg(d,e.latency),t.agentId){let n=o.get(t.agentId)??h_();g_(n,e),o.set(t.agentId,n)}if(t.channel){let n=s.get(t.channel)??h_();g_(n,e),s.set(t.channel,n)}for(let t of e.dailyBreakdown??[]){let e=c.get(t.date)??{date:t.date,tokens:0,cost:0,messages:0,toolCalls:0,errors:0};e.tokens+=t.tokens,e.cost+=t.cost,c.set(t.date,e)}for(let t of e.dailyMessageCounts??[]){let e=c.get(t.date)??{date:t.date,tokens:0,cost:0,messages:0,toolCalls:0,errors:0};e.messages+=t.total,e.toolCalls+=t.toolCalls,e.errors+=t.errors,c.set(t.date,e)}$g(l,e.dailyLatency);for(let t of e.dailyModelUsage??[]){let e=`${t.date}::${t.provider??`unknown`}::${t.model??`unknown`}`,n=u.get(e)??{date:t.date,provider:t.provider,model:t.model,tokens:0,cost:0,count:0};n.tokens+=t.tokens,n.cost+=t.cost,n.count+=t.count,u.set(e,n)}}}let f=e_({byChannelMap:s,latencyTotals:d,dailyLatencyMap:l,modelDailyMap:u,dailyMap:c});return{messages:n,tools:{totalCalls:Array.from(r.values()).reduce((e,t)=>e+t,0),uniqueTools:r.size,tools:Array.from(r.entries()).map(([e,t])=>({name:e,count:t})).toSorted((e,t)=>t.count-e.count)},byModel:Array.from(i.values()).toSorted((e,t)=>t.totals.totalCost-e.totals.totalCost),byProvider:Array.from(a.values()).toSorted((e,t)=>t.totals.totalCost-e.totals.totalCost),byAgent:Array.from(o.entries()).map(([e,t])=>({agentId:e,totals:t})).toSorted((e,t)=>t.totals.totalCost-e.totals.totalCost),...f}},v_=(e,t,n)=>{let r=0,i=0;for(let t of e){let e=t.usage?.durationMs??0;e>0&&(r+=e,i+=1)}let a=i?r/i:0,o=t&&r>0?t.totalTokens/(r/6e4):void 0,s=t&&r>0?t.totalCost/(r/6e4):void 0,c=n.messages.total?n.messages.errors/n.messages.total:0,l=n.daily.filter(e=>e.messages>0&&e.errors>0).map(e=>({date:e.date,errors:e.errors,messages:e.messages,rate:e.errors/e.messages})).toSorted((e,t)=>t.rate-e.rate||t.errors-e.errors)[0];return{durationSumMs:r,durationCount:i,avgDurationMs:a,throughputTokensPerMin:o,throughputCostPerMin:s,errorRate:c,peakErrorDay:l}};function y_(e,t,n=`text/plain`){let r=new Blob([t],{type:`${n};charset=utf-8`}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=e,a.click(),URL.revokeObjectURL(i)}function b_(e){return/[",\n]/.test(e)?`"${e.replaceAll(`"`,`""`)}"`:e}function x_(e){return e.map(e=>e==null?``:b_(String(e))).join(`,`)}var S_=e=>{let t=[x_([`key`,`label`,`agentId`,`channel`,`provider`,`model`,`updatedAt`,`durationMs`,`messages`,`errors`,`toolCalls`,`inputTokens`,`outputTokens`,`cacheReadTokens`,`cacheWriteTokens`,`totalTokens`,`totalCost`])];for(let n of e){let e=n.usage;t.push(x_([n.key,n.label??``,n.agentId??``,n.channel??``,n.modelProvider??n.providerOverride??``,n.model??n.modelOverride??``,n.updatedAt?new Date(n.updatedAt).toISOString():``,e?.durationMs??``,e?.messageCounts?.total??``,e?.messageCounts?.errors??``,e?.messageCounts?.toolCalls??``,e?.input??``,e?.output??``,e?.cacheRead??``,e?.cacheWrite??``,e?.totalTokens??``,e?.totalCost??``]))}return t.join(`
`)},C_=e=>{let t=[x_([`date`,`inputTokens`,`outputTokens`,`cacheReadTokens`,`cacheWriteTokens`,`totalTokens`,`inputCost`,`outputCost`,`cacheReadCost`,`cacheWriteCost`,`totalCost`])];for(let n of e)t.push(x_([n.date,n.input,n.output,n.cacheRead,n.cacheWrite,n.totalTokens,n.inputCost??``,n.outputCost??``,n.cacheReadCost??``,n.cacheWriteCost??``,n.totalCost]));return t.join(`
`)},w_=(e,t,n)=>{let r=e.trim();if(!r)return[];let i=r.length?r.split(/\s+/):[],a=i.length?i[i.length-1]:``,[o,s]=a.includes(`:`)?[a.slice(0,a.indexOf(`:`)),a.slice(a.indexOf(`:`)+1)]:[``,``],c=o.toLowerCase(),l=s.toLowerCase(),u=e=>{let t=new Set;for(let n of e)n&&t.add(n);return Array.from(t)},d=u(t.map(e=>e.agentId)).slice(0,6),f=u(t.map(e=>e.channel)).slice(0,6),p=u([...t.map(e=>e.modelProvider),...t.map(e=>e.providerOverride),...n?.byProvider.map(e=>e.provider)??[]]).slice(0,6),m=u([...t.map(e=>e.model),...n?.byModel.map(e=>e.model)??[]]).slice(0,6),h=u(n?.tools.tools.map(e=>e.name)??[]).slice(0,6);if(!c)return[{label:`agent:`,value:`agent:`},{label:`channel:`,value:`channel:`},{label:`provider:`,value:`provider:`},{label:`model:`,value:`model:`},{label:`tool:`,value:`tool:`},{label:`has:errors`,value:`has:errors`},{label:`has:tools`,value:`has:tools`},{label:`minTokens:`,value:`minTokens:`},{label:`maxCost:`,value:`maxCost:`}];let g=[],_=(e,t)=>{for(let n of t)(!l||n.toLowerCase().includes(l))&&g.push({label:`${e}:${n}`,value:`${e}:${n}`})};switch(c){case`agent`:_(`agent`,d);break;case`channel`:_(`channel`,f);break;case`provider`:_(`provider`,p);break;case`model`:_(`model`,m);break;case`tool`:_(`tool`,h);break;case`has`:[`errors`,`tools`,`context`,`usage`,`model`,`provider`].forEach(e=>{(!l||e.includes(l))&&g.push({label:`has:${e}`,value:`has:${e}`})});break;default:break}return g},T_=(e,t)=>{let n=e.trim();if(!n)return`${t} `;let r=n.split(/\s+/);return r[r.length-1]=t,`${r.join(` `)} `},E_=e=>e.trim().toLowerCase(),D_=(e,t)=>{let n=e.trim();if(!n)return`${t} `;let r=n.split(/\s+/),i=r[r.length-1]??``,a=t.includes(`:`)?t.split(`:`)[0]:null,o=i.includes(`:`)?i.split(`:`)[0]:null;return i.endsWith(`:`)&&a&&o===a?(r[r.length-1]=t,`${r.join(` `)} `):r.includes(t)?`${r.join(` `)} `:`${r.join(` `)} ${t} `},O_=(e,t)=>{let n=e.trim().split(/\s+/).filter(Boolean).filter(e=>e!==t);return n.length?`${n.join(` `)} `:``},k_=(e,t,n)=>{let r=E_(t),i=[...Wg(e).filter(e=>E_(e.key??``)!==r).map(e=>e.raw),...n.map(e=>`${t}:${e}`)];return i.length?`${i.join(` `)} `:``};function A_(e,t){return t===0?0:e/t*100}function j_(e){let t=e.totalCost||0;return{input:{tokens:e.input,cost:e.inputCost||0,pct:A_(e.inputCost||0,t)},output:{tokens:e.output,cost:e.outputCost||0,pct:A_(e.outputCost||0,t)},cacheRead:{tokens:e.cacheRead,cost:e.cacheReadCost||0,pct:A_(e.cacheReadCost||0,t)},cacheWrite:{tokens:e.cacheWrite,cost:e.cacheWriteCost||0,pct:A_(e.cacheWriteCost||0,t)},totalCost:t}}function M_(e,t,r,a,o,s,c,l){if(!(e.length>0||t.length>0||r.length>0))return i;let u=r.length===1?a.find(e=>e.key===r[0]):null,d=u?(u.label||u.key).slice(0,20)+((u.label||u.key).length>20?`…`:``):r.length===1?r[0].slice(0,8)+`…`:`${r.length} sessions`,f=u?u.label||u.key:r.length===1?r[0]:r.join(`, `),p=e.length===1?e[0]:`${e.length} days`,m=t.length===1?`${t[0]}:00`:`${t.length} hours`;return n`
  ...
  `}function N_(e,t,r,a,o,s){if(!e.length)return n`
  ...
  `}function P_(e,t){let r=j_(e),i=t===`tokens`,a=e.totalTokens||1,o={output:A_(e.output,a),input:A_(e.input,a),cacheWrite:A_(e.cacheWrite,a),cacheRead:A_(e.cacheRead,a)};return n`
  ...
  `}function L_(e,t,r,a,o,s,c){if(!e)return i;let l=t.messages.total?Math.round(e.totalTokens/t.messages.total):0,u=t.messages.total?e.totalCost/t.messages.total:0,d=e.input+e.cacheRead,f=d>0?e.cacheRead/d:0,p=d>0?`${(f*100).toFixed(1)}%`:`—`,m=r.errorRate*100,h=r.throughputTokensPerMin===void 0?`—`:`${Z(Math.round(r.throughputTokensPerMin))} tok/min`,g=r.throughputCostPerMin===void 0?`—`:`${Q(r.throughputCostPerMin,4)} / min`,v=r.durationCount>0?_(r.avgDurationMs,{spaced:!0})??`—`:`—`,y=a?`Average cost per message when providers report costs. Cost data is missing for some or all sessions in this range.`:`Average cost per message when providers report costs.`,b=t.daily.filter(e=>e.messages>0&&e.errors>0).map(e=>{let t=e.errors/e.messages;return{label:p_(e.date),value:`${(t*100).toFixed(2)}%`,sub:`${e.errors} errors · ${e.messages} msgs · ${Z(e.tokens)}`,rate:t}}).toSorted((e,t)=>t.rate-e.rate).slice(0,5).map(({rate:e,...t})=>t),x=t.byModel.slice(0,5).map(e=>({label:e.model??`unknown`,value:Q(e.totals.totalCost),sub:`${Z(e.totals.totalTokens)} · ${e.count} msgs`})),S=t.byProvider.slice(0,5).map(e=>({label:e.provider??`unknown`,value:Q(e.totals.totalCost),sub:`${Z(e.totals.totalTokens)} · ${e.count} msgs`})),ee=t.tools.tools.slice(0,6).map(e=>({label:e.name,value:`${e.count}`,sub:`calls`})),C=t.byAgent.slice(0,5).map(e=>({label:e.agentId,value:Q(e.totals.totalCost),sub:Z(e.totals.totalTokens)})),w=t.byChannel.slice(0,5).map(e=>({label:e.channel,value:Q(e.totals.totalCost),sub:Z(e.totals.totalTokens)}));return n`
    <section class="card" style="margin-top: 16px;">
      ...
      <div class="usage-insights-grid">
        ${F_(`Top Models`,x,`No model data`)}
        ${F_(`Top Providers`,S,`No provider data`)}
        ${F_(`Top Tools`,ee,`No tool calls`)}
        ${F_(`Top Agents`,C,`No agent data`)}
        ${F_(`Top Channels`,w,`No channel data`)}
        ${I_(`Peak Error Days`,b,`No error data`)}
        ${I_(`Peak Error Hours`,o,`No error data`)}
      </div>
    </section>
  ...
  `}var z_=.75,B_=.06,V_=5,H_=12,U_=.7;function W_(e,t){return!t||t<=0?0:e/t*100}function G_(){return i}function K_(e){return e<0xe8d4a51000?e*1e3:e}function q_(e,t,n){let r=Math.min(t,n),i=Math.max(t,n);return e.filter(e=>{if(e.timestamp<=0)return!0;let t=K_(e.timestamp);return t>=r&&t<=i})}function J_(e,t,r){let a=t||e.usage;if(!a)return n`
      <div class="muted">No usage data for this session.</div>
    `;let o=e=>e?new Date(e).toLocaleString():`—`,s=[];e.channel&&s.push(`channel:${e.channel}`),e.agentId&&s.push(`agent:${e.agentId}`),(e.modelProvider||e.providerOverride)&&s.push(`provider:${e.modelProvider??e.providerOverride}`),e.model&&s.push(`model:${e.model}`);let c=a.toolUsage?.tools.slice(0,6)??[],l,u,d;if(r){let e=new Map;for(let t of r){let{tools:n}=Zg(t.content);for(let[t]of n)e.set(t,(e.get(t)||0)+1)}d=c.map(t=>({label:t.name,value:`${e.get(t.name)??0}`,sub:`calls`})),l=[...e.values()].reduce((e,t)=>e+t,0),u=e.size}else d=c.map(e=>({label:e.name,value:`${e.count}`,sub:`calls`})),l=a.toolUsage?.totalCalls??0,u=a.toolUsage?.uniqueTools??0;let f=a.modelUsage?.slice(0,6).map(e=>({label:e.model??`unknown`,value:Q(e.totals.totalCost),sub:Z(e.totals.totalTokens)}))??[];return n`
  ...
  `}function Y_(e,t,n,r){let i=Math.min(n,r),a=Math.max(n,r),o=t.filter(e=>e.timestamp>=i&&e.timestamp<=a);if(o.length===0)return;let s=0,c=0,l=0,u=0,d=0,f=0,p=0,m=0;for(let e of o)s+=e.totalTokens||0,c+=e.cost||0,d+=e.input||0,f+=e.output||0,p+=e.cacheRead||0,m+=e.cacheWrite||0,e.output>0&&u++,e.input>0&&l++;return{...e,totalTokens:s,totalCost:c,input:d,output:f,cacheRead:p,cacheWrite:m,durationMs:o[o.length-1].timestamp-o[0].timestamp,firstActivity:o[0].timestamp,lastActivity:o[o.length-1].timestamp,messageCounts:{total:o.length,user:l,assistant:u,toolCalls:0,toolResults:0,errors:0}}}function X_(e,t,r,a,o,s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,ee,C,w,T,E){let D=e.label||e.key,O=D.length>50?D.slice(0,50)+`…`:D,k=e.usage,te=l!==null&&u!==null,A=l!==null&&u!==null&&t?.points&&k?Y_(k,t.points,l,u):void 0,ne=A?{totalTokens:A.totalTokens,totalCost:A.totalCost}:{totalTokens:k?.totalTokens??0,totalCost:k?.totalCost??0},j=A?` (filtered)`:``;return n`
    <div class="card session-detail-panel">
      ...
      <div class="session-detail-content">
        ${J_(e,A,l!=null&&u!=null&&h?q_(h,l,u):void 0)}
        <div class="session-detail-row">
          ${Z_(t,r,a,o,s,c,f,p,m,l,u,d)}
        </div>
        <div class="session-detail-bottom">
          ${$_(h,g,_,v,y,b,x,S,ee,C,te?l:null,te?u:null)}
          ${Q_(e.contextWeight,k,w,T)}
        </div>
      </div>
    </div>
  `}function Z_(e,t,r,o,s,c,l,u,d,f,p,m){if(t)return n`
      ...
      <div class="timeseries-chart-wrapper" style="position: relative; cursor: crosshair;">
        ...
        >
          ...
          ${a`
            ...
            <rect x="${ae-V_/2}" y="${A.top+j/2-H_/2}" width="${V_}" height="${H_}" rx="1.5" fill="var(--accent)" class="cursor-handle" />
            <line x1="${ae-U_}" y1="${A.top+j/2-H_/5}" x2="${ae-U_}" y2="${A.top+j/2+H_/5}" stroke="var(--bg)" stroke-width="0.4" pointer-events="none" />
            <line x1="${ae+U_}" y1="${A.top+j/2-H_/5}" x2="${ae+U_}" y2="${A.top+j/2+H_/5}" stroke="var(--bg)" stroke-width="0.4" pointer-events="none" />
          `}
          <!-- Right cursor line + handle -->
          ${a`
            <line x1="${R}" y1="${A.top}" x2="${R}" y2="${A.top+j}" stroke="var(--accent)" stroke-width="0.8" opacity="0.7" />
            <rect x="${R-V_/2}" y="${A.top+j/2-H_/2}" width="${V_}" height="${H_}" rx="1.5" fill="var(--accent)" class="cursor-handle" />
            <line x1="${R-U_}" y1="${A.top+j/2-H_/5}" x2="${R-U_}" y2="${A.top+j/2+H_/5}" stroke="var(--bg)" stroke-width="0.4" pointer-events="none" />
            <line x1="${R+U_}" y1="${A.top+j/2-H_/5}" x2="${R+U_}" y2="${A.top+j/2+H_/5}" stroke="var(--bg)" stroke-width="0.4" pointer-events="none" />
          `}
        </svg>
      ...
      ${M?n`
              <div style="margin-top: 8px;">
                ...
                <div class="cost-breakdown-bar" style="height: 18px;">
                  <div class="cost-segment output" style="width: ${W_(D,N).toFixed(1)}%"></div>
                  <div class="cost-segment input" style="width: ${W_(O,N).toFixed(1)}%"></div>
                  <div class="cost-segment cache-write" style="width: ${W_(te,N).toFixed(1)}%"></div>
                  <div class="cost-segment cache-read" style="width: ${W_(k,N).toFixed(1)}%"></div>
                </div>
                <div class="cost-breakdown-legend">
  ...
  `}function Q_(e,t,r,a){if(!e)return n`
    ...
    <div class="context-details-panel">
      ...
      <div class="context-stacked-bar">
        <div class="context-segment system" style="width: ${W_(o,u).toFixed(1)}%" title="System: ~${Z(o)}"></div>
        <div class="context-segment skills" style="width: ${W_(s,u).toFixed(1)}%" title="Skills: ~${Z(s)}"></div>
        <div class="context-segment tools" style="width: ${W_(c,u).toFixed(1)}%" title="Tools: ~${Z(c)}"></div>
        <div class="context-segment files" style="width: ${W_(l,u).toFixed(1)}%" title="Files: ~${Z(l)}"></div>
      </div>
  ...
  `}function $_(e,t,r,a,o,s,c,l,u,d,f,p){if(t)return n`
...
`].join(`
`);function tv(){return{input:0,output:0,cacheRead:0,cacheWrite:0,totalTokens:0,totalCost:0,inputCost:0,outputCost:0,cacheReadCost:0,cacheWriteCost:0,missingCostEntries:0}}function nv(e,t){return e.input+=t.input,e.output+=t.output,e.cacheRead+=t.cacheRead,e.cacheWrite+=t.cacheWrite,e.totalTokens+=t.totalTokens,e.totalCost+=t.totalCost,e.inputCost+=t.inputCost??0,e.outputCost+=t.outputCost??0,e.cacheReadCost+=t.cacheReadCost??0,e.cacheWriteCost+=t.cacheWriteCost??0,e.missingCostEntries+=t.missingCostEntries??0,e}function rv(e){if(e.loading&&!e.totals)return n`
      <style>
    ...
    `;let t=e.chartMode===`tokens`,r=e.query.trim().length>0,a=e.queryDraft.trim().length>0,o=[...e.sessions].toSorted((e,n)=>{let r=t?e.usage?.totalTokens??0:e.usage?.totalCost??0;return(t?n.usage?.totalTokens??0:n.usage?.totalCost??0)-r}),s=e.selectedDays.length>0?o.filter(t=>{if(t.usage?.activityDates?.length)return t.usage.activityDates.some(t=>e.selectedDays.includes(t));if(!t.updatedAt)return!1;let n=new Date(t.updatedAt),r=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}-${String(n.getDate()).padStart(2,`0`)}`;return e.selectedDays.includes(r)}):o,c=(t,n)=>{if(n.length===0)return!0;let r=t.usage,i=r?.firstActivity??t.updatedAt,a=r?.lastActivity??t.updatedAt;if(!i||!a)return!1;let o=Math.min(i,a),s=Math.max(i,a),c=o;for(;c<=s;){let t=new Date(c),r=o_(t,e.timeZone);if(n.includes(r))return!0;let i=c_(t,e.timeZone);c=Math.min(i.getTime(),s)+1}return!1},l=Xg(e.selectedHours.length>0?s.filter(t=>c(t,e.selectedHours)):s,e.query),u=l.sessions,d=l.warnings,f=w_(e.queryDraft,o,e.aggregates),p=Wg(e.query),m=e=>{let t=E_(e);return p.filter(e=>E_(e.key??``)===t).map(e=>e.value).filter(Boolean)},h=e=>{let t=new Set;for(let n of e)n&&t.add(n);return Array.from(t)},g=h(o.map(e=>e.agentId)).slice(0,12),_=h(o.map(e=>e.channel)).slice(0,12),v=h([...o.map(e=>e.modelProvider),...o.map(e=>e.providerOverride),...e.aggregates?.byProvider.map(e=>e.provider)??[]]).slice(0,12),y=h([...o.map(e=>e.model),...e.aggregates?.byModel.map(e=>e.model)??[]]).slice(0,12),b=h(e.aggregates?.tools.tools.map(e=>e.name)??[]).slice(0,12),x=e.selectedSessions.length===1?e.sessions.find(t=>t.key===e.selectedSessions[0])??u.find(t=>t.key===e.selectedSessions[0]):null,S=e=>e.reduce((e,t)=>t.usage?nv(e,t.usage):e,tv()),ee=t=>e.costDaily.filter(e=>t.includes(e.date)).reduce((e,t)=>nv(e,t),tv()),C,w,T=o.length;if(e.selectedSessions.length>0){let t=u.filter(t=>e.selectedSessions.includes(t.key));C=S(t),w=t.length}else e.selectedDays.length>0&&e.selectedHours.length===0?(C=ee(e.selectedDays),w=u.length):e.selectedHours.length>0||r?(C=S(u),w=u.length):(C=e.totals,w=T);let E=e.selectedSessions.length>0?u.filter(t=>e.selectedSessions.includes(t.key)):r||e.selectedHours.length>0?u:e.selectedDays.length>0?s:o,D=__(E,e.aggregates),O=e.selectedSessions.length>0?(()=>{let t=u.filter(t=>e.selectedSessions.includes(t.key)),n=new Set;for(let e of t)for(let t of e.usage?.activityDates??[])n.add(t);return n.size>0?e.costDaily.filter(e=>n.has(e.date)):e.costDaily})():e.costDaily,k=v_(E,C,D),te=!e.loading&&!e.totals&&e.sessions.length===0,A=(C?.missingCostEntries??0)>0||(C?C.totalTokens>0&&C.totalCost===0&&C.input+C.output+C.cacheRead+C.cacheWrite>0:!1),ne=[{label:`Today`,days:1},{label:`7d`,days:7},{label:`30d`,days:30}],j=t=>{let n=new Date,r=new Date;r.setDate(r.getDate()-(t-1)),e.onStartDateChange(d_(r)),e.onEndDateChange(d_(n))},re=(t,r,a)=>{if(a.length===0)return i;let o=m(t),s=new Set(o.map(e=>E_(e))),c=a.length>0&&a.every(e=>s.has(E_(e))),l=o.length;return n`
      <details
      ...
      >
        ...
        <div class="usage-filter-popover">
          <div class="usage-filter-actions">
            <button
              class="btn btn-sm"
              @click=${n=>{n.preventDefault(),n.stopPropagation(),e.onQueryDraftChange(k_(e.queryDraft,t,a))}}
              ?disabled=${c}
            >
              Select All
            </button>
            <button
              class="btn btn-sm"
              @click=${n=>{n.preventDefault(),n.stopPropagation(),e.onQueryDraftChange(k_(e.queryDraft,t,[]))}}
              ?disabled=${l===0}
            >
              Clear
            </button>
            ...
            ${a.map(r=>n`
                <label class="usage-filter-option">
                  <input
                    type="checkbox"
                    .checked=${s.has(E_(r))}
                    @change=${n=>{let i=n.target,a=`${t}:${r}`;e.onQueryDraftChange(i.checked?D_(e.queryDraft,a):O_(e.queryDraft,a))}}
                  />
                  <span>${r}</span>
                </label>
              `)}
    ...
    <section class="card usage-header ${e.headerPinned?`pinned`:``}">
            ...
            <div class="usage-export-popover">
              <div class="usage-export-list">
                <button
                  ...
                  @click=${()=>y_(`openclaw-usage-sessions-${M}.csv`,S_(u),`text/csv`)}
                  ?disabled=${u.length===0}
                >
                  Sessions CSV
                </button>
                <button
                  class="usage-export-item"
                  @click=${()=>y_(`openclaw-usage-daily-${M}.csv`,C_(O),`text/csv`)}
                  ?disabled=${O.length===0}
                >
                  Daily CSV
                </button>
                <button
                  class="usage-export-item"
                  @click=${()=>y_(`openclaw-usage-${M}.json`,JSON.stringify({totals:C,sessions:u,daily:O,aggregates:D},null,2),`application/json`)}
      ...
      <div class="usage-header-row">
        <div class="usage-controls">
          ${M_(e.selectedDays,e.selectedHours,e.selectedSessions,e.sessions,e.onClearDays,e.onClearHours,e.onClearSessions,e.onClearFilters)}
                ...
                <div class="usage-query-chips">
                  ${p.map(t=>{let r=t.raw;return n`
                      <span class="usage-query-chip">
                        ...
                        <button
                          title="Remove filter"
                          @click=${()=>e.onQueryDraftChange(O_(e.queryDraft,r))}
                        >
                          ×
                        </button>
                      </span>
                ...
                <div class="usage-query-suggestions">
                  ${f.map(t=>n`
                      <button
                        ...
                        @click=${()=>e.onQueryDraftChange(T_(e.queryDraft,t.value))}
                      >
                        ${t.label}
                      </button>
                    `)}
    ...
    ${L_(C,D,k,A,i_(E,e.timeZone),w,T)}

    ${u_(E,e.timeZone,e.selectedHours,e.onSelectHour)}

    <!-- Two-column layout: Daily+Breakdown on left, Sessions on right -->
    <div class="usage-grid">
      <div class="usage-grid-left">
        <div class="card usage-left-card">
          ${N_(O,e.selectedDays,e.chartMode,e.dailyChartMode,e.onDailyChartModeChange,e.onSelectDay)}
          ${C?P_(C,e.chartMode):i}
        </div>
      </div>
      <div class="usage-grid-right">
        ${R_(u,e.selectedSessions,e.selectedDays,t,e.sessionSort,e.sessionSortDir,e.recentSessions,e.sessionsTab,e.onSelectSession,e.onSessionSortChange,e.onSessionSortDirChange,e.onSessionsTabChange,e.visibleColumns,T,e.onClearSessions)}
      </div>
    </div>
  ...
  `}function dv(e){let t=Sv(e,e.sessionKey,e.sessionsResult),r=yv(e);return n`
  ...
  `}function fv(e){let t=e.sessionsHideCron??!0,r=t?Cv(e.sessionKey,e.sessionsResult):0,i=e.onboarding,a=e.onboarding,o=e.onboarding?!1:e.settings.chatShowThinking,s=e.onboarding?!0:e.settings.chatFocusMode,c=n`
    <svg
      width="18"
      height="18"
      viewBox="0 0 24 24"
  ...
  `}function pv(e,t){e.sessionKey=t,e.chatMessage=``,e.chatStream=null,e.chatQueue=[],e.chatStreamStartedAt=null,e.chatRunId=null,e.resetToolStream(),e.resetChatScroll(),e.applySettings({...e.settings,sessionKey:t,lastActiveSessionKey:t}),e.loadAssistantIdentity(),wp(e,t,!0),Fh(e),mv(e)}async function mv(e){await si(e,{activeMinutes:0,limit:0,includeGlobal:!0,includeUnknown:!0})}function hv(e){return e.sessionsResult?.sessions?.find(t=>t.key===e.sessionKey)}function gv(e){let t=e.chatModelOverrides[e.sessionKey];if(typeof t==`string`)return t.trim();if(t===null)return``;let n=hv(e);return n&&typeof n.model==`string`?n.model.trim():``}function _v(e){let t=e.sessionsResult?.defaults?.model;return typeof t==`string`?t.trim():``}function vv(e,t,n){let r=new Set,i=[],a=(e,t)=>{let n=e.trim();if(!n)return;let a=n.toLowerCase();r.has(a)||(r.add(a),i.push({value:n,label:t??n}))};for(let t of e){let e=t.provider?.trim();a(t.id,e?`${t.id} · ${e}`:t.id)}return t&&a(t),n&&a(n),i}function yv(e){let t=gv(e),r=_v(e),i=vv(e.chatModelCatalog??[],t,r),a=r?`Default (${r})`:`Default model`,o=e.chatLoading||e.chatSending||!!e.chatRunId||e.chatStream!==null;return n`
  ...
  `}async function bv(e,t){if(!e.client||!e.connected||gv(e)===t)return;let n=e.sessionKey,r=e.chatModelOverrides[n];e.lastError=null,e.chatModelOverrides={...e.chatModelOverrides,[n]:t||null};try{await e.client.request(`sessions.patch`,{key:n,model:t||null}),await mv(e)}catch(t){e.chatModelOverrides={...e.chatModelOverrides,[n]:r},e.lastError=`Failed to set model: ${String(t)}`}}function xv(e){let t=e.trim().toLowerCase();if(!t)return!1;if(t.startsWith(`cron:`))return!0;if(!t.startsWith(`agent:`))return!1;let n=t.split(`:`).filter(Boolean);return n.length<3?!1:n.slice(2).join(`:`).startsWith(`cron:`)}function Sv(e,t,n){let r=n?.sessions??[],i=e.sessionsHideCron??!0,a=new Map;for(let e of r)a.set(e.key,e);let o=new Set,s=new Map,c=(e,t)=>{let n=s.get(e);if(n)return n;let r={id:e,label:t,options:[]};return s.set(e,r),r},l=t=>{if(!t||o.has(t))return;o.add(t);let n=a.get(t),r=tt(t),i=r?c(`agent:${r.agentId.toLowerCase()}`,wv(e,r.agentId)):c(`other`,`Other Sessions`),s=Tv(t,n,r?.rest);i.options.push({key:t,label:s,title:t})};for(let e of r)e.key!==t&&(e.kind===`global`||e.kind===`unknown`)||i&&e.key!==t&&xv(e.key)||l(e.key);return l(t),Array.from(s.values())}function Cv(e,t){return t?.sessions?t.sessions.filter(t=>xv(t.key)&&t.key!==e).length:0}function wv(e,t){let n=t.trim().toLowerCase(),r=(e.agentsList?.agents??[]).find(e=>e.id.trim().toLowerCase()===n),i=r?.identity?.name?.trim()||r?.name?.trim()||``;return i&&i!==t?`${i} (${t})`:t}function Tv(e,t,n){let r=n?.trim()||e;if(!t)return r;let i=typeof t.displayName==`string`&&t.displayName.trim().length>0?t.displayName.trim():null,a=typeof t.label==`string`?t.label.trim():``;return i&&i!==e&&i!==a&&i!==r?`${r} · ${i}`:r}var Ev=[{id:`claw`,label:`Claw`,icon:`🦀`},{id:`knot`,label:`Knot`,icon:`🪢`},{id:`dash`,label:`Dash`,icon:`📊`}],Dv=[{id:`system`,label:`System`,short:`SYS`},{id:`light`,label:`Light`,short:`LIGHT`},{id:`dark`,label:`Dark`,short:`DARK`}];function Ov(e){return Ev.find(t=>t.id===e)?.icon??`🎨`}function kv(e){let t=e=>e===`system`?W.monitor:e===`light`?W.sun:W.moon,r=(t,n)=>{t!==e.themeMode&&e.setThemeMode(t,{element:n.currentTarget})};return n`
  ...
  `}function Av(e){let t=e.connected?M(`common.online`):M(`common.offline`);return n`
    <span
  ...
  `};function ny(e){let t=ge(e.value,e.path,e.hints),n=t&&(e.revealSensitive||(e.isSensitivePathRevealed?.(e.path)??!1));return{isSensitive:t,isRedacted:t&&!n,isRevealed:n,canReveal:t}}function ry(e){let{state:t}=e;return!t.isSensitive||!e.onToggleSensitivePath?i:n`
    <button
      type="button"
  ...
  `}function _y(e){let{schema:t,value:r,path:a,hints:o,disabled:s,onPatch:c}=e,l=e.showLabel??!0,{label:u,help:d,tags:f}=sy(a,t,o),p=ey(r),m=ny({path:a,value:r,hints:o,revealSensitive:e.revealSensitive??!1,isSensitivePathRevealed:e.isSensitivePathRevealed}),h=m.isRedacted?``:p,g=s||m.isRedacted;return n`
    <div class="cfg-field">
      ${l?n`<label class="cfg-field__label">${u}</label>`:i}
      ${d?n`<div class="cfg-field__help">${d}</div>`:i}
      ${fy(f)}
  ...
  `}function vy(e){let{schema:t,value:r,path:a,hints:o,unsupported:s,disabled:c,onPatch:l,searchCriteria:u,revealSensitive:d,isSensitivePathRevealed:f,onToggleSensitivePath:p}=e,m=e.showLabel??!0,{label:h,help:g,tags:_}=sy(a,t,o),v=u&&iy(u)&&uy({schema:t,path:a,hints:o,criteria:u})?void 0:u,y=r??t.default,b=y&&typeof y==`object`&&!Array.isArray(y)?y:{},x=t.properties??{},S=Object.entries(x).toSorted((e,t)=>{let n=oe([...a,e[0]],o)?.order??0,r=oe([...a,t[0]],o)?.order??0;return n===r?e[0].localeCompare(t[0]):n-r}),ee=new Set(Object.keys(x)),C=t.additionalProperties,w=!!C&&typeof C==`object`,T=n`
    ...
    ${w?by({schema:C,value:b,path:a,hints:o,unsupported:s,disabled:c,reservedKeys:ee,searchCriteria:v,revealSensitive:d,isSensitivePathRevealed:f,onToggleSensitivePath:p,onPatch:l}):i}
  `;return a.length===1?n`
  ...
  `}var Ey=new Set([`title`,`description`,`default`,`nullable`]);function Dy(e){return Object.keys(e??{}).filter(e=>!Ey.has(e)).length===0}function Oy(e){let t=e.filter(e=>e!=null),n=t.length!==e.length,r=[];for(let e of t)r.some(t=>Object.is(t,e))||r.push(e);return{enumValues:r,nullable:n}}function ky(e){return!e||typeof e!=`object`?{schema:null,unsupportedPaths:[`<root>`]}:Ay(e,[])}function Ay(e,t){let n=new Set,r={...e},i=R(t)||`<root>`;if(e.anyOf||e.oneOf||e.allOf)return Py(e,t)||{schema:e,unsupportedPaths:[i]};let a=Array.isArray(e.type)&&e.type.includes(`null`),o=L(e)??(e.properties||e.additionalProperties?`object`:void 0);if(r.type=o??e.type,r.nullable=a||e.nullable,r.enum){let{enumValues:e,nullable:t}=Oy(r.enum);r.enum=e,t&&(r.nullable=!0),e.length===0&&n.add(i)}if(o===`object`){let a=e.properties??{},o={};for(let[e,r]of Object.entries(a)){let i=Ay(r,[...t,e]);i.schema&&(o[e]=i.schema);for(let e of i.unsupportedPaths)n.add(e)}if(r.properties=o,e.additionalProperties===!0)r.additionalProperties={};else if(e.additionalProperties===!1)r.additionalProperties=!1;else if(e.additionalProperties&&typeof e.additionalProperties==`object`&&!Dy(e.additionalProperties)){let a=Ay(e.additionalProperties,[...t,`*`]);r.additionalProperties=a.schema??e.additionalProperties,a.unsupportedPaths.length>0&&n.add(i)}}else if(o===`array`){let a=Array.isArray(e.items)?e.items[0]:e.items;if(!a)n.add(i);else{let e=Ay(a,[...t,`*`]);r.items=e.schema??a,e.unsupportedPaths.length>0&&n.add(i)}}else o!==`string`&&o!==`number`&&o!==`integer`&&o!==`boolean`&&!r.enum&&n.add(i);return{schema:r,unsupportedPaths:Array.from(n)}}function jy(e){if(L(e)!==`object`)return!1;let t=e.properties?.source,n=e.properties?.provider,r=e.properties?.id;return!t||!n||!r?!1:typeof t.const==`string`&&L(n)===`string`&&L(r)===`string`}function My(e){let t=e.oneOf??e.anyOf;return!t||t.length===0?!1:t.every(e=>jy(e))}function Ny(e,t,n,r){let i=n.findIndex(e=>L(e)===`string`);if(i<0)return null;let a=n.filter((e,t)=>t!==i);return a.length!==1||!My(a[0])?null:Ay({...e,...n[i],nullable:r,anyOf:void 0,oneOf:void 0,allOf:void 0},t)}function Py(e,t){if(e.allOf)return null;let n=e.anyOf??e.oneOf;if(!n)return null;let r=[],i=[],a=!1;for(let e of n){if(!e||typeof e!=`object`)return null;if(Array.isArray(e.enum)){let{enumValues:t,nullable:n}=Oy(e.enum);r.push(...t),n&&(a=!0);continue}if(`const`in e){if(e.const==null){a=!0;continue}r.push(e.const);continue}if(L(e)===`null`){a=!0;continue}i.push(e)}let o=Ny(e,t,i,a);if(o)return o;if(r.length>0&&i.length===0){let t=[];for(let e of r)t.some(t=>Object.is(t,e))||t.push(e);return{schema:{...e,enum:t,nullable:a,anyOf:void 0,oneOf:void 0,allOf:void 0},unsupportedPaths:[]}}if(i.length===1){let e=Ay(i[0],t);return e.schema&&(e.schema.nullable=a||e.schema.nullable),e}let s=new Set([`string`,`number`,`integer`,`boolean`,`object`,`array`]);return i.length>0&&r.length===0&&i.every(e=>{let t=L(e);return!!t&&s.has(String(t))})?{schema:{...e,nullable:a},unsupportedPaths:[]}:null}var Fy={all:n`
  ...
  `}function qy(){return{rawRevealed:!1,envRevealed:!1,validityDismissed:!1,revealedSensitivePaths:new Set}}var Jy=qy();function Yy(e){let t=R(e);return t?Jy.revealedSensitivePaths.has(t):!1}function Xy(e){let t=R(e);t&&(Jy.revealedSensitivePaths.has(t)?Jy.revealedSensitivePaths.delete(t):Jy.revealedSensitivePaths.add(t))}function Zy(e){let t=e.showModeToggle??!1,r=e.valid==null?`unknown`:e.valid?`valid`:`invalid`,a=e.includeVirtualSections??!0,o=e.includeSections?.length?new Set(e.includeSections):null,s=e.excludeSections?.length?new Set(e.excludeSections):null,c=ky(e.schema),l={schema:zy(c.schema,{include:o,exclude:s}),unsupportedPaths:By(c.unsupportedPaths,{include:o,exclude:s})},u=l.schema?l.unsupportedPaths.length>0:!1,d=t?e.formMode:`form`,f=Jy.envRevealed,p=l.schema?.properties??{},m=new Set([`__appearance__`]),h=Iy.map(e=>({...e,sections:e.sections.filter(e=>a&&m.has(e.key)||e.key in p)})).filter(e=>e.sections.length>0),g=Object.keys(p).filter(e=>!Ly.has(e)).map(e=>({key:e,label:e.charAt(0).toUpperCase()+e.slice(1)})),_=g.length>0?{id:`other`,label:`Other`,sections:g}:null,v=a&&e.activeSection!=null&&m.has(e.activeSection),y=e.activeSection&&!v&&l.schema&&L(l.schema)===`object`?l.schema.properties?.[e.activeSection]:void 0,b=e.activeSection&&!v?Vy(e.activeSection,y):null,x=[{key:null,label:e.navRootLabel??`Settings`},...[...h,..._?[_]:[]].flatMap(e=>e.sections.map(e=>({key:e.key,label:e.label})))],S=d===`form`?Hy(e.originalValue,e.formValue):[],ee=d===`raw`&&e.raw!==e.originalRaw,C=d===`form`?S.length>0:ee,w=!!e.formValue&&!e.loading&&!!l.schema,T=e.connected&&!e.saving&&C&&(d===`raw`?!0:w),E=e.connected&&!e.applying&&!e.updating&&C&&(d===`raw`?!0:w),D=e.connected&&!e.applying&&!e.updating,O=a&&d===`form`&&e.activeSection===null&&!!o?.has(`__appearance__`);return n`
      ...
      <main class="config-main">
        ...
        ${r===`invalid`&&!Jy.validityDismissed?n`
              <div class="config-validity-warning">
                ...
                <button
                  class="btn btn--sm"
                  @click=${()=>{Jy.validityDismissed=!0,e.onRawChange(e.raw)}}
	        ...
	        ${b&&d===`form`?n`
                ...
                ${e.activeSection===`env`?n`
                      <button
                        ...
                        @click=${()=>{Jy.envRevealed=!Jy.envRevealed,e.onRawChange(e.raw)}}
                      >
        ...
        <div class="config-content">
          ${e.activeSection===`__appearance__`?a?Ky(e):i:d===`form`?n`
                ...
                ${e.schemaLoading?n`
                      ...
                      `:Ty({schema:l.schema,uiHints:e.uiHints,value:e.formValue,disabled:e.loading||!e.formValue,unsupportedPaths:l.unsupportedPaths,onPatch:e.onFormPatch,searchQuery:e.searchQuery,activeSection:e.activeSection,activeSubsection:null,revealSensitive:e.activeSection===`env`?f:!1,isSensitivePathRevealed:Yy,onToggleSensitivePath:t=>{Xy(t),e.onRawChange(e.raw)}})}
              `:(()=>{let t=_e(e.formValue,[],e.uiHints),r=t>0&&!Jy.rawRevealed;return n`
                    ${u?n`
                      ...
                      <span style="display:flex;align-items:center;gap:8px;">
                        ...
                        ${t>0?n`
                              ...
                              <button
                                ...
                                aria-pressed=${!r}
                                @click=${()=>{Jy.rawRevealed=!Jy.rawRevealed,e.onRawChange(e.raw)}}
                              >
                                ${r?W.eyeOff:W.eye}
                              </button>
                            `:i}
...
${JSON.stringify(e.issues,null,2)}</pre
  ...
  `}function Qy(e){let t=Math.max(0,e),n=Math.floor(t/1e3);if(n<60)return`${n}s`;let r=Math.floor(n/60);return r<60?`${r}m`:`${Math.floor(r/60)}h`}function $y(e,t){return t?n`<div class="exec-approval-meta-row"><span>${e}</span><span>${t}</span></div>`:i}function eb(e){let t=e.execApprovalQueue[0];if(!t)return i;let r=t.request,a=t.expiresAtMs-Date.now(),o=a>0?`expires in ${Qy(a)}`:`expired`,s=e.execApprovalQueue.length;return n`
  ...
  `:i}function nb(e){let t=Vl(Hi(e.basePath??``));return n`
    <div class="login-gate">
      <div class="login-gate__theme">${jv(e)}</div>
...
`);return n`
  ...
  `}function Db(e){let t=e.hello?.snapshot,r=t?.uptimeMs?d(t.uptimeMs):M(`common.na`),a=e.hello?.policy?.tickIntervalMs,o=a?`${(a/1e3).toFixed(a%1e3==0?0:1)}s`:M(`common.na`),s=t?.authMode===`trusted-proxy`,c=Sb(e.connected,e.lastError,e.lastErrorCode)?n`
  ...
  `}var Ob;function kb(e){let t={mod:null,promise:null};return()=>t.mod?t.mod:(t.promise||=e().then(e=>(t.mod=e,Ob?.(),e)),null)}var Ab=kb(()=>E(()=>import(`./agents-DhhcMCCy.js`),__vite__mapDeps([0,1,2,3,4]),import.meta.url)),jb=kb(()=>E(()=>import(`./channels-BXy_MYLs.js`),__vite__mapDeps([5,1,2,3]),import.meta.url)),Mb=kb(()=>E(()=>import(`./cron-C3uQ13-x.js`),__vite__mapDeps([6,1,2]),import.meta.url)),Nb=kb(()=>E(()=>import(`./debug-xYOndlEx.js`),__vite__mapDeps([7,1]),import.meta.url)),Pb=kb(()=>E(()=>import(`./instances-DdRIsNb1.js`),__vite__mapDeps([8,1]),import.meta.url)),Fb=kb(()=>E(()=>import(`./logs-BbHV8FOx.js`),__vite__mapDeps([9,1]),import.meta.url)),Ib=kb(()=>E(()=>import(`./nodes-BwDIV1x7.js`),__vite__mapDeps([10,1,2]),import.meta.url)),Lb=kb(()=>E(()=>import(`./sessions-B9eOwvgG.js`),__vite__mapDeps([11,1,2]),import.meta.url)),Rb=kb(()=>E(()=>import(`./skills-BaxA3XRt.js`),__vite__mapDeps([12,1,2,4]),import.meta.url));function zb(e,t){let n=e();return n?t(n):i}var Bb=`openclaw:control-ui:update-banner-dismissed:v1`,Vb=[`off`,`minimal`,`low`,`medium`,`high`],Hb=[`UTC`,`America/Los_Angeles`,`America/Denver`,`America/Chicago`,`America/New_York`,`Europe/London`,`Europe/Berlin`,`Asia/Tokyo`];function Ub(e){return/^https?:\/\//i.test(e.trim())}function Wb(e){return typeof e==`string`?e.trim():``}function Gb(e){let t=new Set,n=[];for(let r of e){let e=r.trim();if(!e)continue;let i=e.toLowerCase();t.has(i)||(t.add(i),n.push(e))}return n}function Kb(){try{let e=localStorage.getItem(Bb);if(!e)return null;let t=JSON.parse(e);return!t||typeof t.latestVersion!=`string`?null:{latestVersion:t.latestVersion,channel:typeof t.channel==`string`?t.channel:null,dismissedAtMs:typeof t.dismissedAtMs==`number`?t.dismissedAtMs:Date.now()}}catch{return null}}function qb(e){let t=Kb();if(!t)return!1;let n=e,r=n&&typeof n.latestVersion==`string`?n.latestVersion:null,i=n&&typeof n.channel==`string`?n.channel:null;return!!(r&&t.latestVersion===r&&t.channel===i)}function Jb(e){let t=e,n=t&&typeof t.latestVersion==`string`?t.latestVersion:null;if(!n)return;let r={latestVersion:n,channel:t&&typeof t.channel==`string`?t.channel:null,dismissedAtMs:Date.now()};try{localStorage.setItem(Bb,JSON.stringify(r))}catch{}}var Yb=/^data:/i,Xb=/^https?:\/\//i,Zb=[`channels`,`messages`,`broadcast`,`talk`,`audio`],Qb=[`__appearance__`,`ui`,`wizard`],$b=[`commands`,`hooks`,`bindings`,`cron`,`approvals`,`plugins`],ex=[`gateway`,`web`,`browser`,`nodeHost`,`canvasHost`,`discovery`,`media`],tx=[`agents`,`models`,`skills`,`tools`,`memory`,`session`];function nx(e){let t=e.agentsList?.agents??[],n=tt(e.sessionKey)?.agentId??e.agentsList?.defaultId??`main`,r=t.find(e=>e.id===n)?.identity,i=r?.avatarUrl??r?.avatar;if(i)return Yb.test(i)||Xb.test(i)?i:r?.avatarUrl}function rx(e){let t=e,r=typeof t.requestUpdate==`function`?()=>t.requestUpdate?.():void 0;if(Ob=r,!e.connected)return n`
      ${nb(e)}
      ${tb(e)}
    `;let a=e.presenceEntries.length,o=e.sessionsResult?.count??null,s=e.cronStatus?.nextWakeAtMs??null,c=e.connected?null:M(`chat.disconnected`),l=e.tab===`chat`,u=l&&(e.settings.chatFocusMode||e.onboarding),d=!!(e.navDrawerOpen&&!u&&!e.onboarding),f=!!(e.settings.navCollapsed&&!d),p=e.onboarding?!1:e.settings.chatShowThinking,m=nx(e),h=e.chatAvatarUrl??m??null,g=e.configForm??e.configSnapshot?.config,_=Hi(e.basePath??``),v=e.agentsSelectedId??e.agentsList?.defaultId??e.agentsList?.agents?.[0]?.id??null,y=()=>e.configForm??e.configSnapshot?.config,b=e=>Pe(y(),e),x=t=>Fe(e,t),S=$l(new Set([...e.agentsList?.agents?.map(e=>e.id.trim())??[],...e.cronJobs.map(e=>typeof e.agentId==`string`?e.agentId.trim():``).filter(Boolean)].filter(Boolean))),ee=$l(new Set([...e.cronModelSuggestions,...eu(g),...e.cronJobs.map(e=>e.payload.kind!==`agentTurn`||typeof e.payload.model!=`string`?``:e.payload.model.trim()).filter(Boolean)].filter(Boolean))),C=en(e),w=e.cronForm.deliveryChannel&&e.cronForm.deliveryChannel.trim()?e.cronForm.deliveryChannel.trim():`last`,T=e.cronJobs.map(e=>Wb(e.delivery?.to)).filter(Boolean),E=(w===`last`?Object.values(e.channelsSnapshot?.channelAccounts??{}).flat():e.channelsSnapshot?.channelAccounts?.[w]??[]).flatMap(e=>[Wb(e.accountId),Wb(e.name)]).filter(Boolean),D=Gb([...T,...E]),O=Gb(E),k=e.cronForm.deliveryMode===`webhook`?D.filter(e=>Ub(e)):D;return n`
    ...
    >
      ...
      <header class="topbar">
        <div class="topnav-shell">
          ...
          <div class="topnav-shell__actions">
            ...
            <div class="topbar-status">${kv(e)}</div>
          </div>
        </div>
      </header>
      <div class="shell-nav">
      ...
      <main class="content ${l?`content--chat`:``}">
        ...
        ${e.tab===`config`?i:n`<section class="content-header">
              <div>
                ${l?dv(e):n`<div class="page-title">${Ji(e.tab)}</div>`}
        ...
        ${e.tab===`instances`?zb(Pb,t=>t.renderInstances({loading:e.presenceLoading,entries:e.presenceEntries,lastError:e.presenceError,statusMessage:e.presenceStatus,onRefresh:()=>oi(e)})):i}
        ...
        ${e.tab===`chat`?tp({sessionKey:e.sessionKey,onSessionKeyChange:t=>{e.sessionKey=t,e.chatMessage=``,e.chatAttachments=[],e.chatStream=null,e.chatStreamStartedAt=null,e.chatRunId=null,e.chatQueue=[],e.chatSuggestions=[],e.chatSuggestionsLoading=!1,e.chatSuggestionsStale=!1,e.chatSuggestionsError=null,e.chatSuggestionsSelectionText=null,e.chatSuggestionsContextHint=null,e.resetToolStream(),e.resetChatScroll(),e.applySettings({...e.settings,sessionKey:t,lastActiveSessionKey:t}),e.loadAssistantIdentity(),Fh(e),cg(e)},thinkingLevel:e.chatThinkingLevel,showThinking:p,loading:e.chatLoading,sending:e.chatSending,compactionStatus:e.compactionStatus,fallbackStatus:e.fallbackStatus,assistantAvatarUrl:h,messages:e.chatMessages,toolMessages:e.chatToolMessages,streamSegments:e.chatStreamSegments,stream:e.chatStream,streamStartedAt:e.chatStreamStartedAt,draft:e.chatMessage,queue:e.chatQueue,suggestions:e.chatSuggestions,suggestionsLoading:e.chatSuggestionsLoading,suggestionsSettling:e.chatSuggestionsSettling,suggestionsStale:e.chatSuggestionsStale,suggestionsError:e.chatSuggestionsError,suggestionsAutoRefresh:e.chatSuggestionsAutoRefresh,suggestionsContextHint:e.chatSuggestionsContextHint,connected:e.connected,canSend:e.connected,disabledReason:c,error:e.lastError,sessions:e.sessionsResult,focusMode:u,onRefresh:()=>(e.resetToolStream(),Promise.all([Fh(e),cg(e)])),onToggleFocusMode:()=>{e.onboarding||e.applySettings({...e.settings,chatFocusMode:!e.settings.chatFocusMode})},onChatScroll:t=>e.handleChatScroll(t),getDraft:()=>e.chatMessage,onDraftChange:t=>e.chatMessage=t,onRequestUpdate:r,attachments:e.chatAttachments,onAttachmentsChange:t=>e.chatAttachments=t,onRefreshSuggestions:()=>Nh(e,{force:!0,manual:!0,selectionText:e.chatSuggestionsSelectionText??void 0}),onToggleSuggestionsAutoRefresh:()=>{e.chatSuggestionsAutoRefresh=!e.chatSuggestionsAutoRefresh},onSelectionContextChange:t=>{let n=t?.trim()?t.trim():null;n!==e.chatSuggestionsSelectionText&&(e.chatSuggestionsSelectionText=n,e.chatSuggestionsContextHint=n?`Based on selected text`:null,e.chatSuggestionsAutoRefresh&&Nh(e,{force:!0,selectionText:n??void 0}))},onSend:()=>e.handleSendChat(),canAbort:!!e.chatRunId,onAbort:()=>void e.handleAbortChat(),onQueueRemove:t=>e.removeQueuedMessage(t),onNewSession:()=>e.handleSendChat(`/new`,{restoreDraft:!0}),onClearHistory:async()=>{if(!(!e.client||!e.connected))try{await e.client.request(`sessions.reset`,{key:e.sessionKey}),e.chatMessages=[],e.chatStream=null,e.chatRunId=null,e.chatSuggestions=[],e.chatSuggestionsLoading=!1,e.chatSuggestionsStale=!1,e.chatSuggestionsError=null,e.chatSuggestionsSelectionText=null,e.chatSuggestionsContextHint=null,await Fh(e)}catch(t){e.lastError=String(t)}},agentsList:e.agentsList,currentAgentId:v??`main`,onAgentChange:t=>{e.sessionKey=xm({agentId:t}),e.chatMessages=[],e.chatStream=null,e.chatSuggestions=[],e.chatSuggestionsLoading=!1,e.chatSuggestionsStale=!1,e.chatSuggestionsError=null,e.chatSuggestionsSelectionText=null,e.chatSuggestionsContextHint=null,e.chatRunId=null,e.applySettings({...e.settings,sessionKey:e.sessionKey,lastActiveSessionKey:e.sessionKey}),Fh(e),e.loadAssistantIdentity()},onNavigateToAgent:()=>{e.agentsSelectedId=v,e.setTab(`agents`)},onSessionSelect:t=>{e.setSessionKey(t),e.chatMessages=[],e.chatSuggestionsSelectionText=null,e.chatSuggestionsContextHint=null,Fh(e),e.loadAssistantIdentity()},showNewMessages:e.chatNewMessagesBelow&&!e.chatManualRefreshInFlight,onScrollToBottom:()=>e.scrollToBottom(),sidebarOpen:e.sidebarOpen,sidebarContent:e.sidebarContent,sidebarError:e.sidebarError,splitRatio:e.splitRatio,onOpenSidebar:t=>e.handleOpenSidebar(t),onCloseSidebar:()=>e.handleCloseSidebar(),onSplitRatioChange:t=>e.handleSplitRatioChange(t),assistantName:e.assistantName,assistantAvatar:e.assistantAvatar,basePath:e.basePath??``}):i}

        ${e.tab===`config`?Zy({raw:e.configRaw,originalRaw:e.configRawOriginal,valid:e.configValid,issues:e.configIssues,loading:e.configLoading,saving:e.configSaving,applying:e.configApplying,updating:e.updateRunning,connected:e.connected,schema:e.configSchema,schemaLoading:e.configSchemaLoading,uiHints:e.configUiHints,formMode:e.configFormMode,showModeToggle:!0,formValue:e.configForm,originalValue:e.configFormOriginal,searchQuery:e.configSearchQuery,activeSection:e.configActiveSection&&(Zb.includes(e.configActiveSection)||Qb.includes(e.configActiveSection)||$b.includes(e.configActiveSection)||ex.includes(e.configActiveSection)||tx.includes(e.configActiveSection))?null:e.configActiveSection,activeSubsection:e.configActiveSection&&(Zb.includes(e.configActiveSection)||Qb.includes(e.configActiveSection)||$b.includes(e.configActiveSection)||ex.includes(e.configActiveSection)||tx.includes(e.configActiveSection))?null:e.configActiveSubsection,onRawChange:t=>{e.configRaw=t},onFormModeChange:t=>e.configFormMode=t,onFormPatch:(t,n)=>B(e,t,n),onSearchChange:t=>e.configSearchQuery=t,onSectionChange:t=>{e.configActiveSection=t,e.configActiveSubsection=null},onSubsectionChange:t=>e.configActiveSubsection=t,onReload:()=>z(e),onSave:()=>Ae(e),onApply:()=>je(e),onUpdate:()=>Me(e),onOpenFile:()=>Ie(e),version:e.hello?.server?.version??``,theme:e.theme,themeMode:e.themeMode,setTheme:(t,n)=>e.setTheme(t,n),setThemeMode:(t,n)=>e.setThemeMode(t,n),gatewayUrl:e.settings.gatewayUrl,assistantName:e.assistantName,configPath:e.configSnapshot?.path??null,excludeSections:[...Zb,...$b,...ex,...tx,`ui`,`wizard`],includeVirtualSections:!1}):i}
