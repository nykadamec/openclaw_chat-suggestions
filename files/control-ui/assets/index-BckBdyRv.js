const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./agents-CCuP7OnK.js","./lit-BZwq2xLD.js","./format-DeRVtGzv.js","./channel-config-extras-UBRJa-vU.js","./skills-shared-CPLqvR1x.js","./channels-BXjWP_4g.js","./cron-Dp2IvEZE.js","./debug-CUMKqRvF.js","./instances-BTASRQFh.js","./logs-BbHV8FOx.js","./nodes-BwDIV1x7.js","./sessions-DCylHAFx.js","./skills-BaxA3XRt.js"])))=>i.map(i=>d[i]);
  ...
  `}function Yf(e){return`Please implement ${e.toLowerCase()} in the current product flow.`}function Xf(e){let t=e.suggestions??[],n=t.length>0,r=t.some(e=>e.source===`fallback`);return e.suggestionsLoading&&!n?{label:`Loading`,tone:`loading`}:e.suggestionsLoading&&n?{label:`Refreshing`,tone:`refreshing`}:e.suggestionsError||r?{label:`Fallback`,tone:`fallback`}:{label:`Ready`,tone:`ready`}}function Zf(e){if(!e.connected)return i;let t=!!(e.suggestions&&e.suggestions.length>0),r=!!(e.suggestionsLoading&&t),a=!!(e.suggestionsSettling&&t),o=Xf(e),s=t?[{title:`Suggestions`,items:e.suggestions.map(e=>({label:e.label,prompt:e.prompt}))}]:Wf.map(e=>({title:e.title,items:e.items.map(e=>({label:e,prompt:Yf(e)}))}));return n`
    <div class="agent-chat__composer-suggestions">
      <div class="agent-chat__composer-suggestions-header">
        <span class="agent-chat__composer-suggestions-title">Suggestions</span>
...
//# sourceMappingURL=index-BckBdyRv.js.map